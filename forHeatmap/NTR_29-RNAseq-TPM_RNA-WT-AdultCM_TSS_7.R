...
AllResults_g <- "NTR_Heatmap/29-RNAseq-TPM/RNA-WT-AdultCM/TSS/sort7_H3K27ac_WT-KO"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g,   recursive = TRUE) }

toSort1   <- apply( cbind(C6_Average_H3K27ac_WT, C6_Average_H3K27ac_EEDko) ,  1,   howToSort_2D )   
