...
####################################################################################################################################################################################################################################
A0_Gene_TPM_Rep1      <- read.table("/media/yp/yongpeng7/Other_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM.24413genes.TPM.txt",          header=FALSE,   sep="\t",   quote = "",   comment.char = "")  

A1_H2BGFP_H3_Rep1     <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/1_H3_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.1_H3_Rep1.wig.heatmap.xls",                        header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week0_Rep1  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/2_H2bGFP-week0_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.2_H2bGFP-week0_Rep1.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week0_Rep2  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/2_H2bGFP-week0_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.2_H2bGFP-week0_Rep2.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week1_Rep1  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/1_H2bGFP-week1_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.1_H2bGFP-week1_Rep1.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week1_Rep2  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/1_H2bGFP-week1_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.1_H2bGFP-week1_Rep2.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week2_Rep1  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/1_H2bGFP-week2_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.1_H2bGFP-week2_Rep1.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week2_Rep2  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/1_H2bGFP-week2_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.1_H2bGFP-week2_Rep2.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week4_Rep1  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/1_H2bGFP-week4_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.1_H2bGFP-week4_Rep1.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week4_Rep2  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/2_H2BGFP-CM-week4-2015_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.2_H2BGFP-CM-week4-2015_Rep1.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week4_Rep3  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/2_H2BGFP-CM-week4-2015_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.2_H2BGFP-CM-week4-2015_Rep2.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week6_Rep1  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/1_H2bGFP-week6_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.1_H2bGFP-week6_Rep1.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week6_Rep2  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/1_H2bGFP-week6_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.1_H2bGFP-week6_Rep2.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week8_Rep1  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/1_H2bGFP-week8_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.1_H2bGFP-week8_Rep1.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week0_EEDheto_Rep1  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/3_H2BGFP-CM-week0-EEDheto_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.3_H2BGFP-CM-week0-EEDheto_Rep1.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week0_EEDheto_Rep2  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/3_H2BGFP-CM-week0-EEDheto_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.3_H2BGFP-CM-week0-EEDheto_Rep2.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week0_EEDko_Rep1    <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/3_H2BGFP-CM-week0-EEDko_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.3_H2BGFP-CM-week0-EEDko_Rep1.wig.heatmap.xls",        header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week4_EEDheto_Rep1  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/4_H2BGFP-CM-week4-EEDheto_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.4_H2BGFP-CM-week4-EEDheto_Rep1.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week4_EEDheto_Rep2  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/4_H2BGFP-CM-week4-EEDheto_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.4_H2BGFP-CM-week4-EEDheto_Rep2.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week4_EEDko_Rep1    <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/4_H2BGFP-CM-week4-EEDko_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.4_H2BGFP-CM-week4-EEDko_Rep1.wig.heatmap.xls",        header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_week4_EEDko_Rep2    <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/4_H2BGFP-CM-week4-EEDko_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.4_H2BGFP-CM-week4-EEDko_Rep2.wig.heatmap.xls",        header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_banding_Rep1  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/5_H2BGFP-CM-week2.5-banding_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.5_H2BGFP-CM-week2.5-banding_Rep1.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_banding_Rep2  <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/5_H2BGFP-CM-week2.5-banding_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.5_H2BGFP-CM-week2.5-banding_Rep2.wig.heatmap.xls",    header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_sham_Rep1     <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/5_H2BGFP-CM-week2.5-sham_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.5_H2BGFP-CM-week2.5-sham_Rep1.wig.heatmap.xls",          header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A1_H2BGFP_sham_Rep2     <- read.table("/media/yp/yongpeng7/H2BGFP_Matrix/29-RNAseq-TPM/RNA-WT-AdultCM/5_H2BGFP-CM-week2.5-sham_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.5_H2BGFP-CM-week2.5-sham_Rep2.wig.heatmap.xls",          header=FALSE,   sep="\t",   quote = "",   comment.char = "")  

A2_360R1_Fog2_adult_Rep1  <- read.table("/media/yp/helab-1/BillPuLab_360R1_TFs_SE50/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/Fog2-adult_gene_heatmap/RNA-WT-AdultCM.gene.Fog2-adult.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A2_360R1_Fog2_E12_Rep1    <- read.table("/media/yp/helab-1/BillPuLab_360R1_TFs_SE50/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/Fog2-E12.5_gene_heatmap/RNA-WT-AdultCM.gene.Fog2-E12.5.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A2_360R1_Mef2c_adult_Rep1 <- read.table("/media/yp/helab-1/BillPuLab_360R1_TFs_SE50/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/Mef2c-adult_gene_heatmap/RNA-WT-AdultCM.gene.Mef2c-adult.wig.heatmap.xls",         header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A2_360R1_Mef2c_E12_Rep1   <- read.table("/media/yp/helab-1/BillPuLab_360R1_TFs_SE50/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/Mef2c-E12.5_gene_heatmap/RNA-WT-AdultCM.gene.Mef2c-E12.5.wig.heatmap.xls",         header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A2_360R1_Srf_adult_Rep1   <- read.table("/media/yp/helab-1/BillPuLab_360R1_TFs_SE50/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/Srf-adult_gene_heatmap/RNA-WT-AdultCM.gene.Srf-adult.wig.heatmap.xls",             header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A2_360R1_Tbx5_adult_Rep1  <- read.table("/media/yp/helab-1/BillPuLab_360R1_TFs_SE50/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/Tbx5-adult_gene_heatmap/RNA-WT-AdultCM.gene.Tbx5-adult.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A2_360R1_Tbx5_E12_Rep1    <- read.table("/media/yp/helab-1/BillPuLab_360R1_TFs_SE50/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/Tbx5-E12.5_gene_heatmap/RNA-WT-AdultCM.gene.Tbx5-E12.5.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  

A3_MNase_EEDheto_Rep1   <- read.table("/media/yp/RAID0/4-H2BGFP/2-MNase/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/EEDhetoM-lib1610_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.EEDhetoM-lib1610_Rep1.wig.heatmap.xls",     header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A3_MNase_EEDheto_Rep2   <- read.table("/media/yp/RAID0/4-H2BGFP/2-MNase/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/EEDhetoF-lib1612_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.EEDhetoF-lib1612_Rep2.wig.heatmap.xls",     header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A3_MNase_EEDheto_merge  <- read.table("/media/yp/RAID0/4-H2BGFP/2-MNase/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/EEDhetoMF-merge_gene_heatmap/RNA-WT-AdultCM.gene.EEDhetoMF-merge.wig.heatmap.xls",                 header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A3_MNase_EEDko_Rep1     <- read.table("/media/yp/RAID0/4-H2BGFP/2-MNase/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/EEDkoM-lib1611_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.EEDkoM-lib1611_Rep1.wig.heatmap.xls",         header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A3_MNase_EEDko_Rep2     <- read.table("/media/yp/RAID0/4-H2BGFP/2-MNase/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/EEDkoF-lib1613_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.EEDkoF-lib1613_Rep2.wig.heatmap.xls",         header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A3_MNase_EEDko_merge    <- read.table("/media/yp/RAID0/4-H2BGFP/2-MNase/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/EEDkoMF-merge_gene_heatmap/RNA-WT-AdultCM.gene.EEDkoMF-merge.wig.heatmap.xls",                     header=FALSE,   sep="\t",   quote = "",   comment.char = "")  

A4_EED_Adult_Rep1 <- read.table("/media/yp/RAID0/4-H2BGFP/4-EEDadult2/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/EED-lib1663-adult_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.EED-lib1663-adult_Rep1.wig.heatmap.xls",             header=FALSE,   sep="\t",   quote = "",   comment.char = "")                                          
A4_EED_Adult_Rep2 <- read.table("/media/yp/RAID0/4-H2BGFP/4-EEDadult2/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/EED-lib1664-adult_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.EED-lib1664-adult_Rep2.wig.heatmap.xls",             header=FALSE,   sep="\t",   quote = "",   comment.char = "")                                          
A4_EED_P5_Rep1    <- read.table("/media/yp/RAID0/5-EED-Rescue/4_EEDP5/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/EEDP5-lib1601_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.EEDP5-lib1601_Rep1.wig.heatmap.xls",                     header=FALSE,   sep="\t",   quote = "",   comment.char = "")                                          
A4_EED_P5_Rep2    <- read.table("/media/yp/RAID0/5-EED-Rescue/4_EEDP5/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/EEDP5-lib1602_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.EEDP5-lib1602_Rep2.wig.heatmap.xls",                     header=FALSE,   sep="\t",   quote = "",   comment.char = "")                                          

A5_HDAC_HetoHDAC1   <- read.table("/media/yp/RAID0/5-EED-Rescue/5-HDAC/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/heto-lib1643-HDAC1_gene_heatmap/RNA-WT-AdultCM.gene.1-BED_1_heto-lib1643-HDAC1-adultCMs_Rep1.bgsub.Fnor.smooth.wig.heatmap.xls",                 header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A5_HDAC_HetoHDAC2   <- read.table("/media/yp/RAID0/5-EED-Rescue/5-HDAC/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/heto-lib1644-HDAC2_gene_heatmap/RNA-WT-AdultCM.gene.1-BED_1_heto-lib1644-HDAC2-adultCMs_Rep1.bgsub.Fnor.smooth.wig.heatmap.xls",                 header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A5_HDAC_HomoHDAC1   <- read.table("/media/yp/RAID0/5-EED-Rescue/5-HDAC/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/homo-lib1641-HDAC1_gene_heatmap/RNA-WT-AdultCM.gene.1-BED_1_homo-lib1641-HDAC1-adultCMs_Rep1.bgsub.Fnor.smooth.wig.heatmap.xls",                 header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A5_HDAC_HomoHDAC2   <- read.table("/media/yp/RAID0/5-EED-Rescue/5-HDAC/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/homo-lib1642-HDAC2_gene_heatmap/RNA-WT-AdultCM.gene.1-BED_1_homo-lib1642-HDAC2-adultCMs_Rep1.bgsub.Fnor.smooth.wig.heatmap.xls",                 header=FALSE,   sep="\t",   quote = "",   comment.char = "")  

A6_H3K27ac_EEDko_rep1 <- read.table("/media/yp/RAID0/5-EED-Rescue/1-H3K27ac/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/1_H3K27ac-EEDko-AdultCM_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.1_H3K27ac-EEDko-AdultCM_Rep1.wig.heatmap.xls",             header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A6_H3K27ac_EEDko_rep2 <- read.table("/media/yp/RAID0/5-EED-Rescue/1-H3K27ac/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/1_H3K27ac-EEDko-AdultCM_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.1_H3K27ac-EEDko-AdultCM_Rep2.wig.heatmap.xls",             header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A6_H3K27ac_WT_rep1    <- read.table("/media/yp/RAID0/5-EED-Rescue/1-H3K27ac/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/1_H3K27ac-WT-AdultCM_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.1_H3K27ac-WT-AdultCM_Rep1.wig.heatmap.xls",                   header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A6_H3K27ac_WT_rep2    <- read.table("/media/yp/RAID0/5-EED-Rescue/1-H3K27ac/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/1_H3K27ac-WT-AdultCM_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.1_H3K27ac-WT-AdultCM_Rep2.wig.heatmap.xls",                   header=FALSE,   sep="\t",   quote = "",   comment.char = "") 

A7_H3K27me3_EEDko_rep1     <- read.table("/media/yp/RAID0/5-EED-Rescue/2-H3K27me3/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/1_H3K27me3-EEDko-AdultCM_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.1_H3K27me3-EEDko-AdultCM_Rep1.wig.heatmap.xls",     header=FALSE,   sep="\t",   quote = "",   comment.char = "")
A7_H3K27me3_EEDko_rep2     <- read.table("/media/yp/RAID0/5-EED-Rescue/2-H3K27me3/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/1_H3K27me3-EEDko-AdultCM_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.1_H3K27me3-EEDko-AdultCM_Rep2.wig.heatmap.xls",     header=FALSE,   sep="\t",   quote = "",   comment.char = "") 
A7_H3K27me3_WT_rep1        <- read.table("/media/yp/RAID0/5-EED-Rescue/2-H3K27me3/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/1_H3K27me3-WT-AdultCM_Rep1_gene_heatmap/RNA-WT-AdultCM.gene.1_H3K27me3-WT-AdultCM_Rep1.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A7_H3K27me3_WT_rep2        <- read.table("/media/yp/RAID0/5-EED-Rescue/2-H3K27me3/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/1_H3K27me3-WT-AdultCM_Rep2_gene_heatmap/RNA-WT-AdultCM.gene.1_H3K27me3-WT-AdultCM_Rep2.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "") 
A7_H3K27me3_WT_rep3        <- read.table("/media/yp/RAID0/5-EED-Rescue/2-H3K27me3/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/1_H3K27me3-WT-AdultCM_Rep3_gene_heatmap/RNA-WT-AdultCM.gene.1_H3K27me3-WT-AdultCM_Rep3.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  

A8_H3K4me1_Adult_Rep1    <- read.table("/media/yp/RAID_15TB/2014NC-DNAme/SRP033385-HistoneMod/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/H3K4me1-CM-Adult_gene_heatmap/RNA-WT-AdultCM.gene.H3K4me1-CM-Adult.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A8_H3K4me3_Adult_Rep1    <- read.table("/media/yp/RAID_15TB/2014NC-DNAme/SRP033385-HistoneMod/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/H3K4me3-CM-Adult_gene_heatmap/RNA-WT-AdultCM.gene.H3K4me3-CM-Adult.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A8_H3K27ac_Adult_Rep1    <- read.table("/media/yp/RAID_15TB/2014NC-DNAme/SRP033385-HistoneMod/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/H3K27ac-CM-Adult_gene_heatmap/RNA-WT-AdultCM.gene.H3K27ac-CM-Adult.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "") 
A8_H3K27me3_Adult_Rep1   <- read.table("/media/yp/RAID_15TB/2014NC-DNAme/SRP033385-HistoneMod/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/H3K27me3-CM-Adult_gene_heatmap/RNA-WT-AdultCM.gene.H3K27me3-CM-Adult.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A8_MeCP2_Adult_Rep1      <- read.table("/media/yp/RAID_15TB/2014NC-DNAme/SRP033385-HistoneMod/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/MeCP2-adult_gene_heatmap/RNA-WT-AdultCM.gene.MeCP2-adult.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A8_MeCP2_TAC_Rep1        <- read.table("/media/yp/RAID_15TB/2014NC-DNAme/SRP033385-HistoneMod/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/MeCP2-TAC_gene_heatmap/RNA-WT-AdultCM.gene.MeCP2-TAC.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  

A9_GATA4_Ab_Adult_Rep1        <- read.table("/media/yp/RAID_15TB/AHeLab/GSE52123-2014NC/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/1_GATA4-Ab-Adult_gene_heatmap/RNA-WT-AdultCM.gene.1_GATA4-Ab-Adult.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A9_GATA4_fb_Adult_Rep1        <- read.table("/media/yp/RAID_15TB/AHeLab/GSE52123-2014NC/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/1_GATA4-fb-Adult_gene_heatmap/RNA-WT-AdultCM.gene.1_GATA4-fb-Adult.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A9_GATA4_fb_Banding_Rep1      <- read.table("/media/yp/RAID_15TB/AHeLab/GSE52123-2014NC/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/2_GATA4-fb-Banding_gene_heatmap/RNA-WT-AdultCM.gene.2_GATA4-fb-Banding.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A9_GATA4_fb_Sham_Rep1         <- read.table("/media/yp/RAID_15TB/AHeLab/GSE52123-2014NC/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/2_GATA4-fb-Sham_gene_heatmap/RNA-WT-AdultCM.gene.2_GATA4-fb-Sham.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A9_H3K4me1_Adult_Rep1         <- read.table("/media/yp/RAID_15TB/AHeLab/GSE52123-2014NC/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/3_H3K4me1-WT-Adult_gene_heatmap/RNA-WT-AdultCM.gene.3_H3K4me1-WT-Adult.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A9_H3K4me3_Adult_Rep1         <- read.table("/media/yp/RAID_15TB/AHeLab/GSE52123-2014NC/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/3_H3K4me3-WT-Adult_gene_heatmap/RNA-WT-AdultCM.gene.3_H3K4me3-WT-Adult.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A9_H3K27ac_Adult_Rep1         <- read.table("/media/yp/RAID_15TB/AHeLab/GSE52123-2014NC/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/3_H3K27ac-WT-Adult_gene_heatmap/RNA-WT-AdultCM.gene.3_H3K27ac-WT-Adult.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
A9_Pol2_Adult_Rep1            <- read.table("/media/yp/RAID_15TB/AHeLab/GSE52123-2014NC/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/3_Pol2-WT-Adult_gene_heatmap/RNA-WT-AdultCM.gene.3_Pol2-WT-Adult.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "") 
A9_H3K27me3_Adult_Rep1        <- read.table("/media/yp/RAID_15TB/AHeLab/GSE52123-2014NC/DANPOS2/4-Profile/29-RNAseq-TPM/RNA-WT-AdultCM/4_H3K27me3-WT-Adult_gene_heatmap/RNA-WT-AdultCM.gene.4_H3K27me3-WT-Adult.wig.heatmap.xls",           header=FALSE,   sep="\t",   quote = "",   comment.char = "")  
...
noMoreThan <- function(matrix1) {
  matrix1A =  matrix1[,1:1000] 
  matrix1B =  matrix1[,1001:2000]
  print(ncol(matrix1))
  N1 <- nrow(matrix1)
  matrix2 <- matrix1A
  for (i  in c(1:N1) ) {
...
D1_Average_H3 <- C1_Average_H3[, c(200:800)]     
D1_Average_week0 <- C1_Average_week0[, c(200:800)]  
D1_Average_week1 <- C1_Average_week1[, c(200:800)]   
D1_Average_week2 <- C1_Average_week2[, c(200:800)]  
D1_Average_week4 <- C1_Average_week4[, c(200:800)]  
D1_Average_week6 <- C1_Average_week6[, c(200:800)]  
D1_Average_week8 <- C1_Average_week8[, c(200:800)]  
D1_Average_week0_EEDheto <- C1_Average_week0_EEDheto[, c(200:800)]  
D1_Average_week0_EEDko <- C1_Average_week0_EEDko[, c(200:800)]   
D1_Average_week4_EEDheto <- C1_Average_week4_EEDheto[, c(200:800)]  
D1_Average_week4_EEDko <- C1_Average_week4_EEDko[, c(200:800)]   
D1_Average_banding <- C1_Average_banding[, c(200:800)]  
D1_Average_sham <- C1_Average_sham[, c(200:800)]     
	
D2_Average_360R1_Fog2_adult  <- C2_Average_360R1_Fog2_adult[, c(200:800)]  
D2_Average_360R1_Fog2_E12    <- C2_Average_360R1_Fog2_E12[, c(200:800)]               
D2_Average_360R1_Mef2c_adult <- C2_Average_360R1_Mef2c_adult[, c(200:800)] 
D2_Average_360R1_Mef2c_E12   <- C2_Average_360R1_Mef2c_E12[, c(200:800)]   
D2_Average_360R1_Srf_adult   <- C2_Average_360R1_Srf_adult[, c(200:800)]    
D2_Average_360R1_Tbx5_adult  <- C2_Average_360R1_Tbx5_adult[, c(200:800)]  
D2_Average_360R1_Tbx5_E12    <- C2_Average_360R1_Tbx5_E12[, c(200:800)]   

D3_Average_MNase_EEDheto       <- C3_Average_MNase_EEDheto[, c(200:800)]        
D3_Average_MNase_EEDheto_merge <- C3_Average_MNase_EEDheto_merge[, c(200:800)]     
D3_Average_MNase_EEDko         <- C3_Average_MNase_EEDko[, c(200:800)]                
D3_Average_MNase_EEDko_merge   <- C3_Average_MNase_EEDko_merge[, c(200:800)]        

D4_Average_EED_Adult <- C4_Average_EED_Adult[, c(200:800)]                                     
D4_Average_EED_P5    <- C4_Average_EED_P5[, c(200:800)]                                          

D5_Average_HetoHDAC1 <- C5_Average_HetoHDAC1[, c(200:800)] 
D5_Average_HetoHDAC2 <- C5_Average_HetoHDAC2[, c(200:800)]  
D5_Average_HomoHDAC1 <- C5_Average_HomoHDAC1[, c(200:800)] 
D5_Average_HomoHDAC2 <- C5_Average_HomoHDAC2[, c(200:800)]  

D6_Average_H3K27ac_EEDko <- C6_Average_H3K27ac_EEDko[, c(200:800)] 
D6_Average_H3K27ac_WT    <- C6_Average_H3K27ac_WT[, c(200:800)]    

D7_Average_H3K27me3_EEDko <- C7_Average_H3K27me3_EEDko[, c(200:800)] 
D7_Average_H3K27me3_WT    <- C7_Average_H3K27me3_WT[, c(200:800)]    

D8_Average_H3K4me1_Adult  <- C8_Average_H3K4me1_Adult[, c(200:800)]
D8_Average_H3K4me3_Adult  <- C8_Average_H3K4me3_Adult[, c(200:800)]
D8_Average_H3K27ac_Adult  <- C8_Average_H3K27ac_Adult[, c(200:800)]
D8_Average_H3K27me3_Adult <- C8_Average_H3K27me3_Adult[, c(200:800)]
D8_Average_MeCP2_Adult    <- C8_Average_MeCP2_Adult[, c(200:800)]
D8_Average_MeCP2_TAC      <- C8_Average_MeCP2_TAC[, c(200:800)]

D9_Average_GATA4_Ab_Adult   <- C9_Average_GATA4_Ab_Adult[, c(200:800)]
D9_Average_GATA4_fb_Adult   <- C9_Average_GATA4_fb_Adult[, c(200:800)]
D9_Average_GATA4_fb_Banding <- C9_Average_GATA4_fb_Banding[, c(200:800)]
D9_Average_GATA4_fb_Sham    <- C9_Average_GATA4_fb_Sham[, c(200:800)]
D9_Average_H3K4me1_Adult    <- C9_Average_H3K4me1_Adult[, c(200:800)]
D9_Average_H3K4me3_Adult    <- C9_Average_H3K4me3_Adult[, c(200:800)]
D9_Average_H3K27ac_Adult    <- C9_Average_H3K27ac_Adult[, c(200:800)]
D9_Average_Pol2_Adult       <- C9_Average_Pol2_Adult[, c(200:800)]
D9_Average_H3K27me3_Adult   <- C9_Average_H3K27me3_Adult[, c(200:800)]
...
howToSort_2E <- function(vector1) {
  valueToSort = mean( as.numeric( vector1[7:8] ) ) - mean( as.numeric( vector1[9:10]))
  print(valueToSort)
  return(valueToSort)
}
...
AllResults_g <- "AllHeatmaps_NTRproject/29-RNAseq-TPM/RNA-WT-AdultCM/GeneBody/sort4_H2BGFP"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g,   recursive = TRUE) }

toSort1   <- apply( D1_Average_week0,  1, howToSort_1A )   
...
####################################################################################################################################################################################################################################
dir1 <- paste(AllResults_g,  "/1_merged_1000bp",  sep="")
...
myFirstLine <- A1_H2BGFP_H3_Rep1[1, c(204:804)]
names(myFirstLine)
...
E3_Average_MNase_out2             <-    cbind(myRowNames3, myRowNames4,  E3_Average_MNase_EEDheto_sort[25:75],   zeroCol,   E3_Average_MNase_EEDko_sort[25:75] )
...
E3_merge_MNase_out2             <-    cbind(myRowNames3, myRowNames4,  E3_merge_MNase_EEDheto_sort[25:75],   zeroCol,   E3_merge_MNase_EEDko_sort[25:75] )
...
myFirstLine <- A1_H2BGFP_H3_Rep1[1, c(5:1004)]
names(myFirstLine)
