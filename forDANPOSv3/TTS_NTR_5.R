...
subdir_1_part5 <- paste(Part5_g,  "/1-minus-H2BGFPsignal", sep = "")
if( ! file.exists(subdir_1_part5) ) { dir.create(subdir_1_part5) }


MyAverageLines_1(vector2=c(column_Average_H3-column_Average_week0,     column_Average_week0-column_Average_week1,  column_Average_week1-column_Average_week2,  
                           column_Average_week2-column_Average_week4,  column_Average_week4-column_Average_week6,  column_Average_week6-column_Average_week8  ),   
                 numSample2=6,   
                 sampleType2=c( rep("H3-week0", numOfColumns1),    rep("week0-week1", numOfColumns1),  rep("week1-week2", numOfColumns1),  
                                rep("week2-week4", numOfColumns1),    rep("week4-week6", numOfColumns1),  rep("week6-week8",   numOfColumns1)  ), 
                 sampleRank2=c( "H3-week0",  "week0-week1",   "week1-week2",  "week2-week4",  "week4-week6",   "week6-week8" ),     
                 colours2=c( "H3-week0"="red2",   "week0-week1"="cyan2",    "week1-week2"="green2",  "week2-week4"="blue2",  "week4-week6"="purple2",   "week6-week8"="orange2" ), 
                 path2=subdir_1_part5,     fileName2=paste("5-1-1A-WT-6Samples-average-curve_5kb",  mySample_g, sep = "_") ,  
                 title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=-0.2,   Ymax2=0.5,    height2=3.3,   width2=6.0, center2=myCenter_g  )    ## 4cm + 5cm

MyAverageLines_1(vector2=c((column_Average_week0-column_Average_week1)/column_Average_week0,      (column_Average_week1-column_Average_week2)/column_Average_week1,  
                           (column_Average_week2-column_Average_week4)/(2*column_Average_week2),  (column_Average_week4-column_Average_week6)/(2*column_Average_week4),  
                           (column_Average_week6-column_Average_week8)/(2*column_Average_week6)  ),   
                 numSample2=5,   
                 sampleType2=c( rep("week0-week1", numOfColumns1),  rep("week1-week2", numOfColumns1),  
                                rep("week2-week4", numOfColumns1),    rep("week4-week6", numOfColumns1),  rep("week6-week8",   numOfColumns1)  ), 
                 sampleRank2=c("week0-week1",   "week1-week2",  "week2-week4",  "week4-week6",   "week6-week8" ),     
                 colours2=c( "week0-week1"="cyan2",    "week1-week2"="green2",  "week2-week4"="blue2",  "week4-week6"="purple2",   "week6-week8"="orange2" ), 
                 path2=subdir_1_part5,     fileName2=paste("5-1-1B-WT-5Samples-average-curve_5kb",  mySample_g, sep = "_") ,  
                 title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=6.0, center2=myCenter_g  )    ## 4cm + 5cm
...
MyAverageLines_1(vector2=c(column_Average_week0_EEDheto-column_Average_week0_EEDko,  column_Average_week4_EEDheto-column_Average_week4_EEDko  ),   
                 numSample2=2,   
                 sampleType2=c( rep("week0_EEDheto-week0_EEDko", numOfColumns1),     rep("week4_EEDheto-week4_EEDko", numOfColumns1)   ), 
                 sampleRank2=c( "week0_EEDheto-week0_EEDko",   "week4_EEDheto-week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto-week0_EEDko"="red",   "week4_EEDheto-week4_EEDko"="blue" ), 
                 path2=subdir_1_part5,     fileName2=paste("5-1-2A-CKO-2Samples-average-curve_5kb",  mySample_g, sep = "_") ,
                 title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=-0.1,   Ymax2=0.2,     height2=3.3,   width2=8, center2=myCenter_g   )

MyAverageLines_1(vector2=c(column_Average_week0_EEDheto-column_Average_week4_EEDheto,   column_Average_week0_EEDko-column_Average_week4_EEDko  ),   
                 numSample2=2,   
                 sampleType2=c( rep("week0_EEDheto-week4_EEDheto", numOfColumns1),    rep("week0_EEDko-week4_EEDko", numOfColumns1)  ), 
                 sampleRank2=c( "week0_EEDheto-week4_EEDheto",   "week0_EEDko-week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto-week4_EEDheto"="red",  "week0_EEDko-week4_EEDko"="blue" ), 
                 path2=subdir_1_part5,     fileName2=paste("5-1-2B-CKO-2Samples-average-curve_5kb",  mySample_g, sep = "_") ,
                 title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=-0.1,   Ymax2=0.3,     height2=3.3,   width2=8, center2=myCenter_g   )

MyAverageLines_1(vector2=c((column_Average_week0_EEDheto-column_Average_week4_EEDheto)/column_Average_week0_EEDheto,   
                           (column_Average_week0_EEDko-column_Average_week4_EEDko)/column_Average_week0_EEDko  ),   
                 numSample2=2,   
                 sampleType2=c( rep("week0_EEDheto-week4_EEDheto", numOfColumns1),    rep("week0_EEDko-week4_EEDko", numOfColumns1)  ), 
                 sampleRank2=c( "week0_EEDheto-week4_EEDheto",   "week0_EEDko-week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto-week4_EEDheto"="red",  "week0_EEDko-week4_EEDko"="blue" ), 
                 path2=subdir_1_part5,     fileName2=paste("5-1-2C-CKO-2Samples-average-curve_5kb",  mySample_g, sep = "_") ,
                 title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=-0.1,   Ymax2=0.5,     height2=3.3,   width2=8, center2=myCenter_g   )
...
MyAverageLines_1(vector2=c(column_Average_banding-column_Average_sham  ),   
                 numSample2=1,   
                 sampleType2=c( rep("banding-sham", numOfColumns1) ), 
                 sampleRank2=c( "banding-sham"  ),     
                 colours2=c( "banding-sham"="green4"  ), 
                 path2=subdir_1_part5,     fileName2=paste("5-1-3A-TAC-2Samples-average-curve_5kb",  mySample_g, sep = "_") , 
                 title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=-0.1,   Ymax2=0.1,     height2=3.3,   width2=6.15 , center2=myCenter_g  )
...
###########################################################################
subdir_2_part5 <- paste(Part5_g,  "/2-ratio-H2BGFPsignal", sep = "")
...
MyAverageLines_1(vector2=c(column_Average_H3/column_Average_week0,     column_Average_week0/column_Average_week1,  column_Average_week1/column_Average_week2,  
                 ...
                 sampleRank2=c( "H3/week0",  "week0/week1",   "week1/week2",  "week2/week4",  "week4/week6",   "week6/week8" ),     
                 colours2=c( "H3/week0"="red2",   "week0/week1"="cyan2",    "week1/week2"="green2",  "week2/week4"="blue2",  "week4/week6"="purple2",   "week6/week8"="orange2" ), 
                 path2=subdir_2_part5,     fileName2=paste("5-2-1A-WT-6Samples-average-curve_5kb",  mySample_g, sep = "_") ,  
                 title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=2,    height2=3.3,   width2=6.0, center2=myCenter_g  )    ## 4cm + 5cm
...
MyAverageLines_1(vector2=c(column_Average_week0_EEDheto/column_Average_week0_EEDko,  column_Average_week4_EEDheto/column_Average_week4_EEDko  ),   
                 ...
                 sampleRank2=c( "week0_EEDheto/week0_EEDko",   "week4_EEDheto/week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto/week0_EEDko"="red",   "week4_EEDheto/week4_EEDko"="blue" ), 
                 path2=subdir_2_part5,     fileName2=paste("5-2-2A-CKO-2Samples-average-curve_5kb",  mySample_g, sep = "_") ,
                 title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=2,     height2=3.3,   width2=8, center2=myCenter_g   )
...
MyAverageLines_1(vector2=c(column_Average_week0_EEDheto/column_Average_week4_EEDheto,   column_Average_week0_EEDko/column_Average_week4_EEDko  ),   
                 ...
                 sampleRank2=c( "week0_EEDheto/week4_EEDheto",   "week0_EEDko/week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto/week4_EEDheto"="red",  "week0_EEDko/week4_EEDko"="blue" ), 
                 path2=subdir_2_part5,     fileName2=paste("5-2-2B-CKO-2Samples-average-curve_5kb",  mySample_g, sep = "_") ,
                 title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=2,     height2=3.3,   width2=8, center2=myCenter_g   )
...
MyAverageLines_1(vector2=c(column_Average_banding/column_Average_sham  ),   
                 ...
                 sampleRank2=c( "banding/sham"  ),     
                 colours2=c( "banding/sham"="green4"  ), 
                 path2=subdir_2_part5,     fileName2=paste("5-2-3A-TAC-2Samples-average-curve_5kb",  mySample_g, sep = "_") , 
                 title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=2,     height2=3.3,   width2=6.15 , center2=myCenter_g  )
...
###########################################################################
subdir_2A_part5 <- paste(Part5_g,  "/2A-ratio-byH3", sep = "")
if( ! file.exists(subdir_2A_part5) ) { dir.create(subdir_2A_part5) }


MyAverageLines_1(vector2=c(column_Average_H3/column_Average_H3,  column_Average_week0/column_Average_H3, column_Average_week1/column_Average_H3,   
                           column_Average_week2/column_Average_H3, column_Average_week4/column_Average_H3,  column_Average_week6/column_Average_H3, column_Average_week8/column_Average_H3  ),   
                 numSample2=7,   
                 ...
                 path2=subdir_2A_part5,     fileName2=paste("Part3-2A-A-WT-averageCurve-withH3",  "5kb", mySample_g, sep = "_") ,  
                 title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal/H3",   
                 Ymin2=0,   Ymax2=1.5,     height2=3.25,   width2=4.83  , center2=myCenter_g  )


MyAverageLines_1(vector2=c(column_Average_week0_EEDheto/column_Average_H3,  column_Average_week0_EEDko/column_Average_H3,  
                           column_Average_week4_EEDheto/column_Average_H3,  column_Average_week4_EEDko/column_Average_H3  ),   
                 numSample2=4,   
                 ...
                 path2=subdir_2A_part5,     fileName2=paste("Part3-2A-B-EEDko-averageCurve",  "5kb", mySample_g, sep = "_") ,
                 title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal/H3",   
                 Ymin2=0,   Ymax2=1,     height2=3.25,   width2=5.6, center2=myCenter_g   )


MyAverageLines_1(vector2=c(column_Average_banding/column_Average_H3,  column_Average_sham/column_Average_H3  ),   
                 numSample2=2,   
                 sampleType2=c( rep("banding", numOfColumns1),    rep("sham", numOfColumns1)  ), 
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_2A_part5,     fileName2=paste("Part3-2A-C-TAC-averageCurve",  "5kb", mySample_g, sep = "_") ,
                 title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal/H3",   
                 Ymin2=0,   Ymax2=1,     height2=3.25,   width2=4.9 , center2=myCenter_g  )
...
###########################################################################
subdir_3_part5 <- paste(Part5_g,  "/3-sort-by-H3", sep = "")
if( ! file.exists(subdir_3_part5) ) { dir.create(subdir_3_part5) }


sink( file=paste(subdir_3_part5,   "Part5-3-A.runLog",  sep = "/") )

howToSort_5_1A <- function(vector1) {
  valueToSort = mean( as.numeric( vector1[200:300] ) )
  print(valueToSort)
  return(valueToSort)
}
...
dim(Average_H3)
toSort_5_1A   <- apply( Average_H3,  1, howToSort_5_1A )      ## apply( cbind(C10_H3K27me3_WT_average, C10_H3K27me3_EEDko_average),  1, howToSort2 )
length(toSort_5_1A)
index_5_1A     <-   order(toSort_5_1A)      ##  rev( order(toSort1) ) 
length(index_5_1A)
toSort_5_1A[ index_5_1A[1:100] ]

length_eachClass_5_1A <- length(index_5_1A)/5
calss1 <- index_5_1A[(0*length_eachClass_5_1A+1):(1*length_eachClass_5_1A)]
calss2 <- index_5_1A[(1*length_eachClass_5_1A+1):(2*length_eachClass_5_1A)]
calss3 <- index_5_1A[(2*length_eachClass_5_1A+1):(3*length_eachClass_5_1A)]
calss4 <- index_5_1A[(3*length_eachClass_5_1A+1):(4*length_eachClass_5_1A)]
calss5 <- index_5_1A[(4*length_eachClass_5_1A+1):(5*length_eachClass_5_1A)]
length(index_5_1A) - length(calss1)  - length(calss2)  - length(calss3)  - length(calss4)  - length(calss5) 
...
MyAverageLines_1(vector2=c( colMeans(Average_H3[calss1, ]),  colMeans(Average_H3[calss2, ]), colMeans(Average_H3[calss3, ]),  colMeans(Average_H3[calss4, ])  ,  colMeans(Average_H3[calss5, ]) ),   
                 ...
                 path2=subdir_3_part5,     fileName2="3-11-1A-WT-H3-averageCurve",  
...
MyBoxViolinPlot_1(vector2=c( rowMeans(Average_H3[calss1, c(200:300)]),  rowMeans(Average_H3[calss2,  c(200:300)]), rowMeans(Average_H3[calss3,  c(200:300)]),  rowMeans(Average_H3[calss4,  c(200:300)])  ,  rowMeans(Average_H3[calss5,  c(200:300)]) ),       
                  ...
                  sampleRank2=c( "H3_1", "H3_2",  "H3_3",   "H3_4"  ,   "H3_5"  ),     
                  colours2=c("H3_1"="yellow2",  "H3_2"="red2",   "H3_3"="cyan2",    "H3_4"="green2"   ,    "H3_5"="blue2"   ), 
                  path2=subdir_3_part5,     fileName2="3-11-1A-WT-H3-violinPlot",  
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss1,]),  colMeans(Average_week1[calss1,]),   colMeans( Average_week2[calss1,]),   
                 ...
                 path2=subdir_3_part5,     fileName2="3-11-1B-WT-6Samples-averageCurve",  
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss2,]),  colMeans(Average_week1[calss2,]),    colMeans(Average_week2[calss2,]),   
                 ...
                 sampleRank2=c("week0",  "week1",   "week2",  "week4",  "week6",   "week8" ),     
                 colours2=c( "week0"="red2",   "week1"="cyan2",    "week2"="green2",  "week4"="blue2",  "week6"="purple2",   "week8"="orange2" ), 
                 path2=subdir_3_part5,     fileName2="3-11-1C-WT-6Samples-averageCurve",  
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss3,]),  colMeans(Average_week1[calss3,]),  colMeans(Average_week2[calss3,]),   
                 ...
                 sampleRank2=c("week0",  "week1",   "week2",  "week4",  "week6",   "week8" ),     
                 colours2=c( "week0"="red2",   "week1"="cyan2",    "week2"="green2",  "week4"="blue2",  "week6"="purple2",   "week8"="orange2" ), 
                 path2=subdir_3_part5,     fileName2="3-11-1D-WT-6Samples-averageCurve",  
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss4,]),  colMeans(Average_week1[calss4,]),  colMeans(Average_week2[calss4,]),   
                 ...
                 sampleRank2=c("week0",  "week1",   "week2",  "week4",  "week6",   "week8" ),     
                 colours2=c( "week0"="red2",   "week1"="cyan2",    "week2"="green2",  "week4"="blue2",  "week6"="purple2",   "week8"="orange2" ), 
                 path2=subdir_3_part5,     fileName2="3-11-1E-WT-6Samples-averageCurve",  
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss5,]),  colMeans(Average_week1[calss5,]),  colMeans(Average_week2[calss5,]),   
                 ...
                 sampleRank2=c("week0",  "week1",   "week2",  "week4",  "week6",   "week8" ),     
                 colours2=c( "week0"="red2",   "week1"="cyan2",    "week2"="green2",  "week4"="blue2",  "week6"="purple2",   "week8"="orange2" ), 
                 path2=subdir_3_part5,     fileName2="3-11-1F-WT-6Samples-averageCurve",  
...
MyBoxViolinPlot_1(vector2=c( myNTR_7_WT_1[calss1], myNTR_7_WT_1[calss2],  myNTR_7_WT_1[calss3],  myNTR_7_WT_1[calss4],  myNTR_7_WT_1[calss5] ),   
                  ...
                  path2=subdir_3_part5,   fileName2= paste("3-11-1G-WT-NTR-BoxViolin",   "1kb",  mySample_g, sep = "_") ,  
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss1,]), colMeans( Average_week0_EEDko[calss1,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_3_part5,     fileName2="3-11-2A-CKO-4Samples-averageCurve",  
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss2,]),  colMeans(Average_week0_EEDko[calss2,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_3_part5,     fileName2="3-11-2B-CKO-4Samples-averageCurve",  
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss3,]),  colMeans(Average_week0_EEDko[calss3,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_3_part5,     fileName2="3-11-2C-CKO-4Samples-averageCurve",  
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss4,]),  colMeans(Average_week0_EEDko[calss4,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_3_part5,     fileName2="3-11-2D-CKO-4Samples-averageCurve",  
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss5,]),  colMeans(Average_week0_EEDko[calss5,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_3_part5,     fileName2="3-11-2E-CKO-4Samples-averageCurve",  
                 title2="Genes (Highest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.65,    height2=3.3,   width2=6.05 , center2=myCenter_g )
...
MyBoxViolinPlot_1(vector2=c( myNTR_7_EEDheto_2A[calss1], myNTR_7_EEDheto_2A[calss2],  myNTR_7_EEDheto_2A[calss3],  myNTR_7_EEDheto_2A[calss4],  myNTR_7_EEDheto_2A[calss5],
                  ...
                  path2=subdir_3_part5,   fileName2= paste("3-11-2F-NTR-BoxViolin",   "1kb",  mySample_g, sep = "_") ,  
                  title2=myTitle_g,   xLab2="Samples",    yLab2="NTR",   
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss1,]),  colMeans(Average_sham[calss1,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_3_part5,     fileName2="3-11-3A-TAC-2Samples-averageCurve",  
                 title2="Genes (Lowest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss2,]),  colMeans(Average_sham[calss2,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_3_part5,     fileName2="3-11-3B-TAC-2Samples-averageCurve",  
                 title2="Genes (Low TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=5.15 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss3,]),  colMeans(Average_sham[calss3,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_3_part5,     fileName2="3-11-3C-TAC-2Samples-averageCurve",  
                 title2="Genes (High TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=5.15 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss4,]),  colMeans(Average_sham[calss4,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_3_part5,     fileName2="3-11-3D-TAC-2Samples-averageCurve",  
                 title2="Genes (Highest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=5.15 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss5,]),  colMeans(Average_sham[calss5,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_3_part5,     fileName2="3-11-3E-TAC-2Samples-averageCurve",  
                 title2="Genes (Highest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=5.15 , center2=myCenter_g )
...
MyBoxViolinPlot_1(vector2=c( myNTR_7_banding_3A[calss1], myNTR_7_banding_3A[calss2],  myNTR_7_banding_3A[calss3],  myNTR_7_banding_3A[calss4],  myNTR_7_banding_3A[calss5],
                  ...
                  path2=subdir_3_part5,   fileName2= paste("3-11-3F-TAC-NTR-BoxViolin",   "1kb",  mySample_g, sep = "_") ,  
                  title2=myTitle_g,   xLab2="Samples",    yLab2="NTR",   
...
###########################################################################
subdir_4_part5 <- paste(Part5_g,  "/4-sort-week0H2BGFP", sep = "")
if( ! file.exists(subdir_4_part5) ) { dir.create(subdir_4_part5) }


sink( file=paste(subdir_4_part5,   "Part5-4-A.runLog",  sep = "/") )
...
dim(Average_week0)
toSort_5_1A   <- apply( Average_week0,  1, howToSort_5_1A )      ## apply( cbind(C10_H3K27me3_WT_average, C10_H3K27me3_EEDko_average),  1, howToSort2 )
length(toSort_5_1A)
index_5_1A     <-   order(toSort_5_1A)      ##  rev( order(toSort1) ) 
length(index_5_1A)
toSort_5_1A[ index_5_1A[1:100] ]
...
MyAverageLines_1(vector2=c( colMeans(Average_H3[calss1, ]),  colMeans(Average_H3[calss2, ]), colMeans(Average_H3[calss3, ]),  colMeans(Average_H3[calss4, ])  ,  colMeans(Average_H3[calss5, ]) ),   
                 ...
                 sampleRank2=c( "H3_1", "H3_2",  "H3_3",   "H3_4"  ,   "H3_5"   ),     
                 colours2=c( "H3_1"="yellow2",  "H3_2"="red2",   "H3_3"="cyan2",    "H3_4"="green2"   ,    "H3_5"="blue2"  ), 
                 path2=subdir_4_part5,     fileName2="4-11-1A-WT-H3-averageCurve",  
                 title2="H3 Level",     xLab2="Relative distance (kb)",    yLab2="H3 signal",   
                 Ymin2=0,   Ymax2=2.0,    height2=3.3,   width2=5.0 , center2=myCenter_g )
...
MyBoxViolinPlot_1(vector2=c( rowMeans(Average_H3[calss1, c(200:300)]),  rowMeans(Average_H3[calss2,  c(200:300)]), rowMeans(Average_H3[calss3,  c(200:300)]),  rowMeans(Average_H3[calss4,  c(200:300)])  ,  rowMeans(Average_H3[calss5,  c(200:300)]) ),       
                  ...
                  sampleRank2=c( "H3_1", "H3_2",  "H3_3",   "H3_4"  ,   "H3_5"  ),     
                  colours2=c("H3_1"="yellow2",  "H3_2"="red2",   "H3_3"="cyan2",    "H3_4"="green2"   ,    "H3_5"="blue2"   ), 
                  path2=subdir_4_part5,     fileName2="4-11-1A-WT-H3-violinPlot",  
                  title2=myTitle_g,     xLab2="Samples",    yLab2="H3 signal",   
                  Ymin2=0,   Ymax2=2,    height2=5,   width2=3.5  )
...
MyAverageLines_1(vector2=c( colMeans(Average_week0[calss1, ]),  colMeans(Average_week0[calss2, ]), colMeans(Average_week0[calss3, ]),  colMeans(Average_week0[calss4, ])  ,  colMeans(Average_week0[calss5, ]) ),   
                 ...
                 path2=subdir_4_part5,     fileName2="4-11-1A-WT-week0-averageCurve",  
...
MyBoxViolinPlot_1(vector2=c( rowMeans(Average_week0[calss1, c(200:300)]),  rowMeans(Average_week0[calss2,  c(200:300)]), rowMeans(Average_week0[calss3,  c(200:300)]),  rowMeans(Average_week0[calss4,  c(200:300)])  ,  rowMeans(Average_week0[calss5,  c(200:300)]) ),       
                  ...
                  sampleRank2=c( "week0_1", "week0_2",  "week0_3",   "week0_4"  ,   "week0_5"  ),     
                  colours2=c("week0_1"="yellow2",  "week0_2"="red2",   "week0_3"="cyan2",    "week0_4"="green2"   ,    "week0_5"="blue2"   ), 
                  path2=subdir_4_part5,     fileName2="4-11-1A-WT-week0-violinPlot",  
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss1,]),  colMeans(Average_week1[calss1,]),   colMeans( Average_week2[calss1,]),   
                 ...
                 sampleRank2=c("week0",  "week1",   "week2",  "week4",  "week6",   "week8" ),     
                 colours2=c( "week0"="red2",   "week1"="cyan2",    "week2"="green2",  "week4"="blue2",  "week6"="purple2",   "week8"="orange2" ), 
                 path2=subdir_4_part5,     fileName2="4-11-1B-WT-6Samples-averageCurve",  
                 title2="NOL (Lowest)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=1.25,    height2=3.3,   width2=5.0 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss2,]),  colMeans(Average_week1[calss2,]),    colMeans(Average_week2[calss2,]),   
                 ...
                 sampleRank2=c("week0",  "week1",   "week2",  "week4",  "week6",   "week8" ),     
                 colours2=c( "week0"="red2",   "week1"="cyan2",    "week2"="green2",  "week4"="blue2",  "week6"="purple2",   "week8"="orange2" ), 
                 path2=subdir_4_part5,     fileName2="4-11-1C-WT-6Samples-averageCurve",  
                 title2="NOL (Low)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=1.25,    height2=3.3,   width2=5.0 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss3,]),  colMeans(Average_week1[calss3,]),  colMeans(Average_week2[calss3,]),   
                 ...
                 sampleRank2=c("week0",  "week1",   "week2",  "week4",  "week6",   "week8" ),     
                 colours2=c( "week0"="red2",   "week1"="cyan2",    "week2"="green2",  "week4"="blue2",  "week6"="purple2",   "week8"="orange2" ), 
                 path2=subdir_4_part5,     fileName2="4-11-1D-WT-6Samples-averageCurve",  
                 title2="NOL (Medium)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=1.25,    height2=3.3,   width2=5.0 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss4,]),  colMeans(Average_week1[calss4,]),  colMeans(Average_week2[calss4,]),   
                 ...
                 sampleRank2=c("week0",  "week1",   "week2",  "week4",  "week6",   "week8" ),     
                 colours2=c( "week0"="red2",   "week1"="cyan2",    "week2"="green2",  "week4"="blue2",  "week6"="purple2",   "week8"="orange2" ), 
                 path2=subdir_4_part5,     fileName2="4-11-1E-WT-6Samples-averageCurve",  
                 title2="NOL (High TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=1.25,    height2=3.3,   width2=5.0 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss5,]),  colMeans(Average_week1[calss5,]),  colMeans(Average_week2[calss5,]),   
                 ...
                 sampleRank2=c("week0",  "week1",   "week2",  "week4",  "week6",   "week8" ),     
                 colours2=c( "week0"="red2",   "week1"="cyan2",    "week2"="green2",  "week4"="blue2",  "week6"="purple2",   "week8"="orange2" ), 
                 path2=subdir_4_part5,     fileName2="4-11-1F-WT-6Samples-averageCurve",  
                 title2="NOL (Highest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=1.25,    height2=3.3,   width2=5.0 , center2=myCenter_g )
...
MyBoxViolinPlot_1(vector2=c( myNTR_7_WT_1[calss1], myNTR_7_WT_1[calss2],  myNTR_7_WT_1[calss3],  myNTR_7_WT_1[calss4],  myNTR_7_WT_1[calss5] ),   
                  ...
                  sampleRank2=c( "Lowest",  "Low",   "Medium",  "High",  "Highest"  ),     
                  colours2=c( "Lowest"="red2",   "Low"="cyan2",    "Medium"="green2",  "High"="blue2",  "Highest"="purple2"  ), 
                  path2=subdir_4_part5,   fileName2= paste("4-11-1G-WT-NTR-BoxViolin",   "1kb",  mySample_g, sep = "_") ,  
                  title2=myTitle_g,   xLab2="Samples",    yLab2="NTR",   
                  height2=4.0,   width2=3.5,   Ymin2=0, Ymax2=0.4)    ## width = 1 + 5*0.5, height=5cm 
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss1,]), colMeans( Average_week0_EEDko[calss1,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_4_part5,     fileName2="4-11-2A-CKO-4Samples-averageCurve",  
                 title2="Genes (Lowest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.65,    height2=3.3,   width2=6.05 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss2,]),  colMeans(Average_week0_EEDko[calss2,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_4_part5,     fileName2="4-11-2B-CKO-4Samples-averageCurve",  
                 title2="Genes (Low TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.65,    height2=3.3,   width2=6.05 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss3,]),  colMeans(Average_week0_EEDko[calss3,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_4_part5,     fileName2="4-11-2C-CKO-4Samples-averageCurve",  
                 title2="Genes (High TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.65,    height2=3.3,   width2=6.05 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss4,]),  colMeans(Average_week0_EEDko[calss4,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_4_part5,     fileName2="4-11-2D-CKO-4Samples-averageCurve",  
                 title2="Genes (Highest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.65,    height2=3.3,   width2=6.05 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss5,]),  colMeans(Average_week0_EEDko[calss5,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_4_part5,     fileName2="4-11-2E-CKO-4Samples-averageCurve",  
                 title2="Genes (Highest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.65,    height2=3.3,   width2=6.05 , center2=myCenter_g )
...
MyBoxViolinPlot_1(vector2=c( myNTR_7_EEDheto_2A[calss1], myNTR_7_EEDheto_2A[calss2],  myNTR_7_EEDheto_2A[calss3],  myNTR_7_EEDheto_2A[calss4],  myNTR_7_EEDheto_2A[calss5],
                  ...
                  colours2=c( "EEDheto_Lowest"="red2",   "EEDheto_Low"="cyan2",    "EEDheto_Medium"="green2",  "EEDheto_High"="blue2",  "EEDheto_Highest"="purple2" ,
                              "EEDko_Lowest"="red2",     "EEDko_Low"="cyan2",      "EEDko_Medium"="green2",    "EEDko_High"="blue2",    "EEDko_Highest"="purple2" ), 
                  path2=subdir_4_part5,   fileName2= paste("4-11-2F-NTR-BoxViolin",   "1kb",  mySample_g, sep = "_") ,  
                  title2=myTitle_g,   xLab2="Samples",    yLab2="NTR",   
                  height2=4.0,   width2=6,   Ymin2=0, Ymax2=0.3)    ## width = 1 + 10*0.5, height=5cm 
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss1,]),  colMeans(Average_sham[calss1,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_4_part5,     fileName2="4-11-3A-TAC-2Samples-averageCurve",  
                 title2="Genes (Lowest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=5.15 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss2,]),  colMeans(Average_sham[calss2,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_4_part5,     fileName2="4-11-3B-TAC-2Samples-averageCurve",  
                 title2="Genes (Low TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=5.15 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss3,]),  colMeans(Average_sham[calss3,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_4_part5,     fileName2="4-11-3C-TAC-2Samples-averageCurve",  
                 title2="Genes (High TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=5.15 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss4,]),  colMeans(Average_sham[calss4,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_4_part5,     fileName2="4-11-3D-TAC-2Samples-averageCurve",  
                 title2="Genes (Highest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=5.15 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss5,]),  colMeans(Average_sham[calss5,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_4_part5,     fileName2="4-11-3E-TAC-2Samples-averageCurve",  
                 title2="Genes (Highest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=5.15 , center2=myCenter_g )
...
MyBoxViolinPlot_1(vector2=c( myNTR_7_banding_3A[calss1], myNTR_7_banding_3A[calss2],  myNTR_7_banding_3A[calss3],  myNTR_7_banding_3A[calss4],  myNTR_7_banding_3A[calss5],
                  ...
                  colours2=c( "banding_Lowest"="red2",   "banding_Low"="cyan2",    "banding_Medium"="green2",  "banding_High"="blue2",  "banding_Highest"="purple2" ,
                              "sham_Lowest"="red2",      "sham_Low"="cyan2",       "sham_Medium"="green2",     "sham_High"="blue2",     "sham_Highest"="purple2"  ), 
                  path2=subdir_4_part5,   fileName2= paste("4-11-3F-TAC-NTR-BoxViolin",   "1kb",  mySample_g, sep = "_") ,  
                  title2=myTitle_g,   xLab2="Samples",    yLab2="NTR",   
                  height2=4.0,   width2=6,   Ymin2=0, Ymax2=1.5)    ## width = 1 + 10*0.5, height=5cm 
...
###########################################################################
subdir_5_part5 <- paste(Part5_g,  "/5-sort-week8H2BGFP", sep = "")
if( ! file.exists(subdir_5_part5) ) { dir.create(subdir_5_part5) }


sink( file=paste(subdir_5_part5,   "Part5-5-A.runLog",  sep = "/") )
...
dim(Average_week8)
toSort_5_1A   <- apply( Average_week8,  1, howToSort_5_1A )      ## apply( cbind(C10_H3K27me3_WT_average, C10_H3K27me3_EEDko_average),  1, howToSort2 )
length(toSort_5_1A)
index_5_1A     <-   order(toSort_5_1A)      ##  rev( order(toSort1) ) 
length(index_5_1A)
toSort_5_1A[ index_5_1A[1:100] ]
...
MyAverageLines_1(vector2=c( colMeans(Average_H3[calss1, ]),  colMeans(Average_H3[calss2, ]), colMeans(Average_H3[calss3, ]),  colMeans(Average_H3[calss4, ])  ,  colMeans(Average_H3[calss5, ]) ),   
                 ...
                 sampleRank2=c( "H3_1", "H3_2",  "H3_3",   "H3_4"  ,   "H3_5"   ),     
                 colours2=c( "H3_1"="yellow2",  "H3_2"="red2",   "H3_3"="cyan2",    "H3_4"="green2"   ,    "H3_5"="blue2"  ), 
                 path2=subdir_5_part5,     fileName2="5-11-1A-WT-H3-averageCurve",  
                 title2="H3 Level",     xLab2="Relative distance (kb)",    yLab2="H3 signal",   
                 Ymin2=0,   Ymax2=2.0,    height2=3.3,   width2=5.0 , center2=myCenter_g )
...
MyBoxViolinPlot_1(vector2=c( rowMeans(Average_H3[calss1, c(200:300)]),  rowMeans(Average_H3[calss2,  c(200:300)]), rowMeans(Average_H3[calss3,  c(200:300)]),  rowMeans(Average_H3[calss4,  c(200:300)])  ,  rowMeans(Average_H3[calss5,  c(200:300)]) ),       
                  ...
                  sampleRank2=c( "H3_1", "H3_2",  "H3_3",   "H3_4"  ,   "H3_5"  ),     
                  colours2=c("H3_1"="yellow2",  "H3_2"="red2",   "H3_3"="cyan2",    "H3_4"="green2"   ,    "H3_5"="blue2"   ), 
                  path2=subdir_5_part5,     fileName2="5-11-1A-WT-H3-violinPlot",  
                  title2=myTitle_g,     xLab2="Samples",    yLab2="H3 signal",   
                  Ymin2=0,   Ymax2=2,    height2=5,   width2=3.5  )
...
MyAverageLines_1(vector2=c( colMeans(Average_week0[calss1, ]),  colMeans(Average_week0[calss2, ]), colMeans(Average_week0[calss3, ]),  colMeans(Average_week0[calss4, ])  ,  colMeans(Average_week0[calss5, ]) ),   
                 ...
                 sampleRank2=c( "week0_1", "week0_2",  "week0_3",   "week0_4"  ,   "week0_5"   ),     
                 colours2=c( "week0_1"="yellow2",  "week0_2"="red2",   "week0_3"="cyan2",    "week0_4"="green2"   ,    "week0_5"="blue2"  ), 
                 path2=subdir_5_part5,     fileName2="5-11-1A-WT-week0-averageCurve",  
                 title2="week0 Level",     xLab2="Relative distance (kb)",    yLab2="week0 signal",   
                 Ymin2=0,   Ymax2=2.0,    height2=3.3,   width2=5.0 , center2=myCenter_g )
...
MyBoxViolinPlot_1(vector2=c( rowMeans(Average_week0[calss1, c(200:300)]),  rowMeans(Average_week0[calss2,  c(200:300)]), rowMeans(Average_week0[calss3,  c(200:300)]),  rowMeans(Average_week0[calss4,  c(200:300)])  ,  rowMeans(Average_week0[calss5,  c(200:300)]) ),       
                  ...
                  sampleRank2=c( "week0_1", "week0_2",  "week0_3",   "week0_4"  ,   "week0_5"  ),     
                  colours2=c("week0_1"="yellow2",  "week0_2"="red2",   "week0_3"="cyan2",    "week0_4"="green2"   ,    "week0_5"="blue2"   ), 
                  path2=subdir_5_part5,     fileName2="5-11-1A-WT-week0-violinPlot",  
                  title2=myTitle_g,     xLab2="Samples",    yLab2="week0 signal",   
                  Ymin2=0,   Ymax2=2,    height2=5,   width2=3.5  )
...
MyAverageLines_1(vector2=c( colMeans(Average_week8[calss1, ]),  colMeans(Average_week8[calss2, ]), colMeans(Average_week8[calss3, ]),  colMeans(Average_week8[calss4, ])  ,  colMeans(Average_week8[calss5, ]) ),   
                 ...
                 path2=subdir_5_part5,     fileName2="5-11-1A-WT-week8-averageCurve",  
...
MyBoxViolinPlot_1(vector2=c( rowMeans(Average_week8[calss1, c(200:300)]),  rowMeans(Average_week8[calss2,  c(200:300)]), rowMeans(Average_week8[calss3,  c(200:300)]),  rowMeans(Average_week8[calss4,  c(200:300)])  ,  rowMeans(Average_week8[calss5,  c(200:300)]) ),       
                  ...
                  sampleRank2=c( "week8_1", "week8_2",  "week8_3",   "week8_4"  ,   "week8_5"  ),     
                  colours2=c("week8_1"="yellow2",  "week8_2"="red2",   "week8_3"="cyan2",    "week8_4"="green2"   ,    "week8_5"="blue2"   ), 
                  path2=subdir_5_part5,     fileName2="5-11-1A-WT-week8-violinPlot",  
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss1,]),  colMeans(Average_week1[calss1,]),   colMeans( Average_week2[calss1,]),   
                 ...
                 sampleRank2=c("week0",  "week1",   "week2",  "week4",  "week6",   "week8" ),     
                 colours2=c( "week0"="red2",   "week1"="cyan2",    "week2"="green2",  "week4"="blue2",  "week6"="purple2",   "week8"="orange2" ), 
                 path2=subdir_5_part5,     fileName2="5-11-1B-WT-6Samples-averageCurve",  
                 title2="NOL (Lowest)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=1.25,    height2=3.3,   width2=5.0 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss2,]),  colMeans(Average_week1[calss2,]),    colMeans(Average_week2[calss2,]),   
                 ...
                 sampleRank2=c("week0",  "week1",   "week2",  "week4",  "week6",   "week8" ),     
                 colours2=c( "week0"="red2",   "week1"="cyan2",    "week2"="green2",  "week4"="blue2",  "week6"="purple2",   "week8"="orange2" ), 
                 path2=subdir_5_part5,     fileName2="5-11-1C-WT-6Samples-averageCurve",  
                 title2="NOL (Low)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=1.25,    height2=3.3,   width2=5.0 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss3,]),  colMeans(Average_week1[calss3,]),  colMeans(Average_week2[calss3,]),   
                 ...
                 sampleRank2=c("week0",  "week1",   "week2",  "week4",  "week6",   "week8" ),     
                 colours2=c( "week0"="red2",   "week1"="cyan2",    "week2"="green2",  "week4"="blue2",  "week6"="purple2",   "week8"="orange2" ), 
                 path2=subdir_5_part5,     fileName2="5-11-1D-WT-6Samples-averageCurve",  
                 title2="NOL (Medium)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=1.25,    height2=3.3,   width2=5.0 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss4,]),  colMeans(Average_week1[calss4,]),  colMeans(Average_week2[calss4,]),   
                 ...
                 sampleRank2=c("week0",  "week1",   "week2",  "week4",  "week6",   "week8" ),     
                 colours2=c( "week0"="red2",   "week1"="cyan2",    "week2"="green2",  "week4"="blue2",  "week6"="purple2",   "week8"="orange2" ), 
                 path2=subdir_5_part5,     fileName2="5-11-1E-WT-6Samples-averageCurve",  
                 title2="NOL (High TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=1.25,    height2=3.3,   width2=5.0 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0[calss5,]),  colMeans(Average_week1[calss5,]),  colMeans(Average_week2[calss5,]),   
                 ...
                 sampleRank2=c("week0",  "week1",   "week2",  "week4",  "week6",   "week8" ),     
                 colours2=c( "week0"="red2",   "week1"="cyan2",    "week2"="green2",  "week4"="blue2",  "week6"="purple2",   "week8"="orange2" ), 
                 path2=subdir_5_part5,     fileName2="5-11-1F-WT-6Samples-averageCurve",  
                 title2="NOL (Highest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=1.25,    height2=3.3,   width2=5.0 , center2=myCenter_g )
...
MyBoxViolinPlot_1(vector2=c( myNTR_7_WT_1[calss1], myNTR_7_WT_1[calss2],  myNTR_7_WT_1[calss3],  myNTR_7_WT_1[calss4],  myNTR_7_WT_1[calss5] ),   
                  ...
                  sampleRank2=c( "Lowest",  "Low",   "Medium",  "High",  "Highest"  ),     
                  colours2=c( "Lowest"="red2",   "Low"="cyan2",    "Medium"="green2",  "High"="blue2",  "Highest"="purple2"  ), 
                  path2=subdir_5_part5,   fileName2= paste("5-11-1G-WT-NTR-BoxViolin",   "1kb",  mySample_g, sep = "_") ,  
                  title2=myTitle_g,   xLab2="Samples",    yLab2="NTR",   
                  height2=4.0,   width2=3.5,   Ymin2=0, Ymax2=0.4)    ## width = 1 + 5*0.5, height=5cm 
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss1,]), colMeans( Average_week0_EEDko[calss1,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_5_part5,     fileName2="5-11-2A-CKO-4Samples-averageCurve",  
                 title2="Genes (Lowest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.65,    height2=3.3,   width2=6.05 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss2,]),  colMeans(Average_week0_EEDko[calss2,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_5_part5,     fileName2="5-11-2B-CKO-4Samples-averageCurve",  
                 title2="Genes (Low TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.65,    height2=3.3,   width2=6.05 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss3,]),  colMeans(Average_week0_EEDko[calss3,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_5_part5,     fileName2="5-11-2C-CKO-4Samples-averageCurve",  
                 title2="Genes (High TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.65,    height2=3.3,   width2=6.05 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss4,]),  colMeans(Average_week0_EEDko[calss4,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_5_part5,     fileName2="5-11-2D-CKO-4Samples-averageCurve",  
                 title2="Genes (Highest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.65,    height2=3.3,   width2=6.05 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_week0_EEDheto[calss5,]),  colMeans(Average_week0_EEDko[calss5,]),      
                 ...
                 sampleRank2=c( "week0_EEDheto",  "week0_EEDko",   "week4_EEDheto",  "week4_EEDko"  ),     
                 colours2=c( "week0_EEDheto"="red",  "week0_EEDko"="red4",   "week4_EEDheto"="skyblue",  "week4_EEDko"="blue" ), 
                 path2=subdir_5_part5,     fileName2="5-11-2E-CKO-4Samples-averageCurve",  
                 title2="Genes (Highest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.65,    height2=3.3,   width2=6.05 , center2=myCenter_g )
...
MyBoxViolinPlot_1(vector2=c( myNTR_7_EEDheto_2A[calss1], myNTR_7_EEDheto_2A[calss2],  myNTR_7_EEDheto_2A[calss3],  myNTR_7_EEDheto_2A[calss4],  myNTR_7_EEDheto_2A[calss5],
                  ...
                  colours2=c( "EEDheto_Lowest"="red2",   "EEDheto_Low"="cyan2",    "EEDheto_Medium"="green2",  "EEDheto_High"="blue2",  "EEDheto_Highest"="purple2" ,
                              "EEDko_Lowest"="red2",     "EEDko_Low"="cyan2",      "EEDko_Medium"="green2",    "EEDko_High"="blue2",    "EEDko_Highest"="purple2" ), 
                  path2=subdir_5_part5,   fileName2= paste("5-11-2F-NTR-BoxViolin",   "1kb",  mySample_g, sep = "_") ,  
                  title2=myTitle_g,   xLab2="Samples",    yLab2="NTR",   
                  height2=4.0,   width2=6,   Ymin2=0, Ymax2=0.3)    ## width = 1 + 10*0.5, height=5cm 
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss1,]),  colMeans(Average_sham[calss1,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_5_part5,     fileName2="5-11-3A-TAC-2Samples-averageCurve",  
                 title2="Genes (Lowest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=5.15 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss2,]),  colMeans(Average_sham[calss2,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_5_part5,     fileName2="5-11-3B-TAC-2Samples-averageCurve",  
                 title2="Genes (Low TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=5.15 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss3,]),  colMeans(Average_sham[calss3,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_5_part5,     fileName2="5-11-3C-TAC-2Samples-averageCurve",  
                 title2="Genes (High TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=5.15 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss4,]),  colMeans(Average_sham[calss4,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_5_part5,     fileName2="5-11-3D-TAC-2Samples-averageCurve",  
                 title2="Genes (Highest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=5.15 , center2=myCenter_g )
...
MyAverageLines_1(vector2=c(colMeans(Average_banding[calss5,]),  colMeans(Average_sham[calss5,])  ),   
                 ...
                 sampleRank2=c( "banding",   "sham"  ),     
                 colours2=c( "banding"="blue",  "sham"="green4"  ), 
                 path2=subdir_5_part5,     fileName2="5-11-3E-TAC-2Samples-averageCurve",  
                 title2="Genes (Highest TPM)",     xLab2="Relative distance (kb)",    yLab2="H2BGFP signal",   
                 Ymin2=0,   Ymax2=0.5,    height2=3.3,   width2=5.15 , center2=myCenter_g )
...
MyBoxViolinPlot_1(vector2=c( myNTR_7_banding_3A[calss1], myNTR_7_banding_3A[calss2],  myNTR_7_banding_3A[calss3],  myNTR_7_banding_3A[calss4],  myNTR_7_banding_3A[calss5],
                  ...
                  colours2=c( "banding_Lowest"="red2",   "banding_Low"="cyan2",    "banding_Medium"="green2",  "banding_High"="blue2",  "banding_Highest"="purple2" ,
                              "sham_Lowest"="red2",      "sham_Low"="cyan2",       "sham_Medium"="green2",     "sham_High"="blue2",     "sham_Highest"="purple2"  ), 
                  path2=subdir_5_part5,   fileName2= paste("5-11-3F-TAC-NTR-BoxViolin",   "1kb",  mySample_g, sep = "_") ,  
                  title2=myTitle_g,   xLab2="Samples",    yLab2="NTR",   
                  height2=4.0,   width2=6,   Ymin2=0, Ymax2=1.5)    ## width = 1 + 10*0.5, height=5cm 
