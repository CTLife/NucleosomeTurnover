...
#################################################################### Start ##########################################################################################################################################
H3_Rep1     <- read.table("RNA-WT-AdultCM/1_H3_Rep1_TTS_heatmap/RNA-WT-AdultCM.tts.1_H3_Rep1.wig.heatmap.xls",                        header=TRUE,   sep="",   quote = "",   comment.char = "")  
week0_Rep1  <- read.table("RNA-WT-AdultCM/2_H2bGFP-week0_Rep1_TTS_heatmap/RNA-WT-AdultCM.tts.2_H2bGFP-week0_Rep1.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week0_Rep2  <- read.table("RNA-WT-AdultCM/2_H2bGFP-week0_Rep2_TTS_heatmap/RNA-WT-AdultCM.tts.2_H2bGFP-week0_Rep2.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week1_Rep1  <- read.table("RNA-WT-AdultCM/1_H2bGFP-week1_Rep1_TTS_heatmap/RNA-WT-AdultCM.tts.1_H2bGFP-week1_Rep1.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week1_Rep2  <- read.table("RNA-WT-AdultCM/1_H2bGFP-week1_Rep2_TTS_heatmap/RNA-WT-AdultCM.tts.1_H2bGFP-week1_Rep2.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week2_Rep1  <- read.table("RNA-WT-AdultCM/1_H2bGFP-week2_Rep1_TTS_heatmap/RNA-WT-AdultCM.tts.1_H2bGFP-week2_Rep1.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week2_Rep2  <- read.table("RNA-WT-AdultCM/1_H2bGFP-week2_Rep2_TTS_heatmap/RNA-WT-AdultCM.tts.1_H2bGFP-week2_Rep2.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week4_Rep1  <- read.table("RNA-WT-AdultCM/1_H2bGFP-week4_Rep1_TTS_heatmap/RNA-WT-AdultCM.tts.1_H2bGFP-week4_Rep1.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week4_Rep2  <- read.table("RNA-WT-AdultCM/2_H2BGFP-CM-week4-2015_Rep1_TTS_heatmap/RNA-WT-AdultCM.tts.2_H2BGFP-CM-week4-2015_Rep1.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week4_Rep3  <- read.table("RNA-WT-AdultCM/2_H2BGFP-CM-week4-2015_Rep2_TTS_heatmap/RNA-WT-AdultCM.tts.2_H2BGFP-CM-week4-2015_Rep2.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week6_Rep1  <- read.table("RNA-WT-AdultCM/1_H2bGFP-week6_Rep1_TTS_heatmap/RNA-WT-AdultCM.tts.1_H2bGFP-week6_Rep1.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week6_Rep2  <- read.table("RNA-WT-AdultCM/1_H2bGFP-week6_Rep2_TTS_heatmap/RNA-WT-AdultCM.tts.1_H2bGFP-week6_Rep2.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week8_Rep1  <- read.table("RNA-WT-AdultCM/1_H2bGFP-week8_Rep1_TTS_heatmap/RNA-WT-AdultCM.tts.1_H2bGFP-week8_Rep1.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week0_EEDheto_Rep1  <- read.table("RNA-WT-AdultCM/3_H2BGFP-CM-week0-EEDheto_Rep1_TTS_heatmap/RNA-WT-AdultCM.tts.3_H2BGFP-CM-week0-EEDheto_Rep1.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week0_EEDheto_Rep2  <- read.table("RNA-WT-AdultCM/3_H2BGFP-CM-week0-EEDheto_Rep2_TTS_heatmap/RNA-WT-AdultCM.tts.3_H2BGFP-CM-week0-EEDheto_Rep2.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week0_EEDko_Rep1    <- read.table("RNA-WT-AdultCM/3_H2BGFP-CM-week0-EEDko_Rep1_TTS_heatmap/RNA-WT-AdultCM.tts.3_H2BGFP-CM-week0-EEDko_Rep1.wig.heatmap.xls",        header=TRUE,   sep="",   quote = "",   comment.char = "")  
week4_EEDheto_Rep1  <- read.table("RNA-WT-AdultCM/4_H2BGFP-CM-week4-EEDheto_Rep1_TTS_heatmap/RNA-WT-AdultCM.tts.4_H2BGFP-CM-week4-EEDheto_Rep1.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week4_EEDheto_Rep2  <- read.table("RNA-WT-AdultCM/4_H2BGFP-CM-week4-EEDheto_Rep2_TTS_heatmap/RNA-WT-AdultCM.tts.4_H2BGFP-CM-week4-EEDheto_Rep2.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
week4_EEDko_Rep1    <- read.table("RNA-WT-AdultCM/4_H2BGFP-CM-week4-EEDko_Rep1_TTS_heatmap/RNA-WT-AdultCM.tts.4_H2BGFP-CM-week4-EEDko_Rep1.wig.heatmap.xls",        header=TRUE,   sep="",   quote = "",   comment.char = "")  
week4_EEDko_Rep2    <- read.table("RNA-WT-AdultCM/4_H2BGFP-CM-week4-EEDko_Rep2_TTS_heatmap/RNA-WT-AdultCM.tts.4_H2BGFP-CM-week4-EEDko_Rep2.wig.heatmap.xls",        header=TRUE,   sep="",   quote = "",   comment.char = "")  
banding_Rep1  <- read.table("RNA-WT-AdultCM/5_H2BGFP-CM-week2.5-banding_Rep1_TTS_heatmap/RNA-WT-AdultCM.tts.5_H2BGFP-CM-week2.5-banding_Rep1.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
banding_Rep2  <- read.table("RNA-WT-AdultCM/5_H2BGFP-CM-week2.5-banding_Rep2_TTS_heatmap/RNA-WT-AdultCM.tts.5_H2BGFP-CM-week2.5-banding_Rep2.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")  
sham_Rep1     <- read.table("RNA-WT-AdultCM/5_H2BGFP-CM-week2.5-sham_Rep1_TTS_heatmap/RNA-WT-AdultCM.tts.5_H2BGFP-CM-week2.5-sham_Rep1.wig.heatmap.xls",          header=TRUE,   sep="",   quote = "",   comment.char = "")  
sham_Rep2     <- read.table("RNA-WT-AdultCM/5_H2BGFP-CM-week2.5-sham_Rep2_TTS_heatmap/RNA-WT-AdultCM.tts.5_H2BGFP-CM-week2.5-sham_Rep2.wig.heatmap.xls",          header=TRUE,   sep="",   quote = "",   comment.char = "")  
...
sink( file=paste(Part2_g,  "/Part2-2-B-summary-each-column.txt",      sep = "") )
print(  apply( H3_Rep1, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  week0_Rep1, 2, summary )  )
cat("\n\n\n\n\n")
print(  apply(  week0_Rep2, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  week1_Rep1, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  week1_Rep2, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  week2_Rep1, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  week2_Rep2, 2, summary )  )
cat("\n\n\n\n\n")
print(  apply(  week4_Rep1, 2, summary )  )
cat("\n\n\n\n\n")
print(  apply(  week4_Rep2, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  week4_Rep3, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  week6_Rep1, 2, summary )  )
cat("\n\n\n\n\n")
print(  apply(  week6_Rep2, 2, summary )  )
cat("\n\n\n\n\n")
print(  apply(  week8_Rep1, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  week0_EEDheto_Rep1, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  week0_EEDheto_Rep2, 2, summary )  )  
cat("\n\n\n\n\n")
print(  apply(  week0_EEDko_Rep1, 2, summary )  )  
cat("\n\n\n\n\n")
print(  apply(  week4_EEDheto_Rep1, 2, summary )  )  
cat("\n\n\n\n\n")
print(  apply(  week4_EEDheto_Rep2, 2, summary )  )  
cat("\n\n\n\n\n")
print(  apply(  week4_EEDko_Rep1, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  week4_EEDko_Rep2, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  banding_Rep1, 2, summary )  )  
cat("\n\n\n\n\n")
print(  apply(  banding_Rep2, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  sham_Rep1, 2, summary )  )
cat("\n\n\n\n\n")
print(  apply(  sham_Rep2, 2, summary )  )  
sink() 




sink( file=paste(Part2_g,  "/Part2-2-C-summary-whole-Matrix.txt",      sep = "") )
...
sink( file=paste(Part2_g,  "/Part2-2-D-distribution-whole-Matrix.txt",      sep = "") )

cat("H3_Rep1:\n")
length(H3_Rep1[H3_Rep1==0])/length(H3_Rep1)
length(H3_Rep1[H3_Rep1<0.05])/length(H3_Rep1)
length(H3_Rep1[H3_Rep1<0.1])/length(H3_Rep1)
length(H3_Rep1[H3_Rep1<0.2])/length(H3_Rep1)
length(H3_Rep1[H3_Rep1<0.3])/length(H3_Rep1)
cat("\n\n\n\n\n")

cat("week0_Rep1:\n")
length(week0_Rep1[week0_Rep1==0])/length(week0_Rep1)
length(week0_Rep1[week0_Rep1<0.05])/length(week0_Rep1)
length(week0_Rep1[week0_Rep1<0.1])/length(week0_Rep1)
length(week0_Rep1[week0_Rep1<0.2])/length(week0_Rep1)
length(week0_Rep1[week0_Rep1<0.3])/length(week0_Rep1)
cat("\n\n\n\n\n")

cat("week0_Rep2:\n")
length(week0_Rep2[week0_Rep2==0])/length(week0_Rep2)
length(week0_Rep2[week0_Rep2<0.05])/length(week0_Rep2)
length(week0_Rep2[week0_Rep2<0.1])/length(week0_Rep2)
length(week0_Rep2[week0_Rep2<0.2])/length(week0_Rep2)
length(week0_Rep2[week0_Rep2<0.3])/length(week0_Rep2)
cat("\n\n\n\n\n")

cat("week1_Rep1:\n")
length(week1_Rep1[week1_Rep1==0])/length(week1_Rep1)
length(week1_Rep1[week1_Rep1<0.05])/length(week1_Rep1)
length(week1_Rep1[week1_Rep1<0.1])/length(week1_Rep1)
length(week1_Rep1[week1_Rep1<0.2])/length(week1_Rep1)
length(week1_Rep1[week1_Rep1<0.3])/length(week1_Rep1)
cat("\n\n\n\n\n")

cat("week1_Rep2:\n")
length(week1_Rep2[week1_Rep2==0])/length(week1_Rep2)
length(week1_Rep2[week1_Rep2<0.05])/length(week1_Rep2)
length(week1_Rep2[week1_Rep2<0.1])/length(week1_Rep2)
length(week1_Rep2[week1_Rep2<0.2])/length(week1_Rep2)
length(week1_Rep2[week1_Rep2<0.3])/length(week1_Rep2)
cat("\n\n\n\n\n")


cat("week2_Rep1:\n")
length(week2_Rep1[week2_Rep1==0])/length(week2_Rep1)
length(week2_Rep1[week2_Rep1<0.05])/length(week2_Rep1)
length(week2_Rep1[week2_Rep1<0.1])/length(week2_Rep1)
length(week2_Rep1[week2_Rep1<0.2])/length(week2_Rep1)
length(week2_Rep1[week2_Rep1<0.3])/length(week2_Rep1)
cat("\n\n\n\n\n")

cat("week2_Rep2:\n")
length(week2_Rep2[week2_Rep2==0])/length(week2_Rep2)
length(week2_Rep2[week2_Rep2<0.05])/length(week2_Rep2)
length(week2_Rep2[week2_Rep2<0.1])/length(week2_Rep2)
length(week2_Rep2[week2_Rep2<0.2])/length(week2_Rep2)
length(week2_Rep2[week2_Rep2<0.3])/length(week2_Rep2)
cat("\n\n\n\n\n")



cat("week4_Rep1:\n")
length(week4_Rep1[week4_Rep1==0])/length(week4_Rep1)
length(week4_Rep1[week4_Rep1<0.05])/length(week4_Rep1)
length(week4_Rep1[week4_Rep1<0.1])/length(week4_Rep1)
length(week4_Rep1[week4_Rep1<0.2])/length(week4_Rep1)
length(week4_Rep1[week4_Rep1<0.3])/length(week4_Rep1)
cat("\n\n\n\n\n")

cat("week4_Rep2:\n")
length(week4_Rep2[week4_Rep2==0])/length(week4_Rep2)
length(week4_Rep2[week4_Rep2<0.05])/length(week4_Rep2)
length(week4_Rep2[week4_Rep2<0.1])/length(week4_Rep2)
length(week4_Rep2[week4_Rep2<0.2])/length(week4_Rep2)
length(week4_Rep2[week4_Rep2<0.3])/length(week4_Rep2)
cat("\n\n\n\n\n")

cat("week4_Rep3:\n")
length(week4_Rep3[week4_Rep3==0])/length(week4_Rep3)
length(week4_Rep3[week4_Rep3<0.05])/length(week4_Rep3)
length(week4_Rep3[week4_Rep3<0.1])/length(week4_Rep3)
length(week4_Rep3[week4_Rep3<0.2])/length(week4_Rep3)
length(week4_Rep3[week4_Rep3<0.3])/length(week4_Rep3)
cat("\n\n\n\n\n")


cat("week6_Rep1:\n")
length(week6_Rep1[week6_Rep1==0])/length(week6_Rep1)
length(week6_Rep1[week6_Rep1<0.05])/length(week6_Rep1)
length(week6_Rep1[week6_Rep1<0.1])/length(week6_Rep1)
length(week6_Rep1[week6_Rep1<0.2])/length(week6_Rep1)
length(week6_Rep1[week6_Rep1<0.3])/length(week6_Rep1)
cat("\n\n\n\n\n")

cat("week6_Rep2:\n")
length(week6_Rep2[week6_Rep2==0])/length(week6_Rep2)
length(week6_Rep2[week6_Rep2<0.05])/length(week6_Rep2)
length(week6_Rep2[week6_Rep2<0.1])/length(week6_Rep2)
length(week6_Rep2[week6_Rep2<0.2])/length(week6_Rep2)
length(week6_Rep2[week6_Rep2<0.3])/length(week6_Rep2)
cat("\n\n\n\n\n")


cat("week8_Rep1:\n")
length(week8_Rep1[week8_Rep1==0])/length(week8_Rep1)
length(week8_Rep1[week8_Rep1<0.05])/length(week8_Rep1)
length(week8_Rep1[week8_Rep1<0.1])/length(week8_Rep1)
length(week8_Rep1[week8_Rep1<0.2])/length(week8_Rep1)
length(week8_Rep1[week8_Rep1<0.3])/length(week8_Rep1)
cat("\n\n\n\n\n")


cat("week0_EEDheto_Rep1:\n")
length(week0_EEDheto_Rep1[week0_EEDheto_Rep1==0])/length(week0_EEDheto_Rep1)
length(week0_EEDheto_Rep1[week0_EEDheto_Rep1<0.05])/length(week0_EEDheto_Rep1)
length(week0_EEDheto_Rep1[week0_EEDheto_Rep1<0.1])/length(week0_EEDheto_Rep1)
length(week0_EEDheto_Rep1[week0_EEDheto_Rep1<0.2])/length(week0_EEDheto_Rep1)
length(week0_EEDheto_Rep1[week0_EEDheto_Rep1<0.3])/length(week0_EEDheto_Rep1)
cat("\n\n\n\n\n")

cat("week0_EEDheto_Rep2:\n")
length(week0_EEDheto_Rep2[week0_EEDheto_Rep2==0])/length(week0_EEDheto_Rep2)
length(week0_EEDheto_Rep2[week0_EEDheto_Rep2<0.05])/length(week0_EEDheto_Rep2)
length(week0_EEDheto_Rep2[week0_EEDheto_Rep2<0.1])/length(week0_EEDheto_Rep2)
length(week0_EEDheto_Rep2[week0_EEDheto_Rep2<0.2])/length(week0_EEDheto_Rep2)
length(week0_EEDheto_Rep2[week0_EEDheto_Rep2<0.3])/length(week0_EEDheto_Rep2)
cat("\n\n\n\n\n")


cat("week0_EEDko_Rep1:\n")
length(week0_EEDko_Rep1[week0_EEDko_Rep1==0])/length(week0_EEDko_Rep1)
length(week0_EEDko_Rep1[week0_EEDko_Rep1<0.05])/length(week0_EEDko_Rep1)
length(week0_EEDko_Rep1[week0_EEDko_Rep1<0.1])/length(week0_EEDko_Rep1)
length(week0_EEDko_Rep1[week0_EEDko_Rep1<0.2])/length(week0_EEDko_Rep1)
length(week0_EEDko_Rep1[week0_EEDko_Rep1<0.3])/length(week0_EEDko_Rep1)
cat("\n\n\n\n\n")


cat("week4_EEDheto_Rep1:\n")
length(week4_EEDheto_Rep1[week4_EEDheto_Rep1==0])/length(week4_EEDheto_Rep1)
length(week4_EEDheto_Rep1[week4_EEDheto_Rep1<0.05])/length(week4_EEDheto_Rep1)
length(week4_EEDheto_Rep1[week4_EEDheto_Rep1<0.1])/length(week4_EEDheto_Rep1)
length(week4_EEDheto_Rep1[week4_EEDheto_Rep1<0.2])/length(week4_EEDheto_Rep1)
length(week4_EEDheto_Rep1[week4_EEDheto_Rep1<0.3])/length(week4_EEDheto_Rep1)
cat("\n\n\n\n\n")

cat("week4_EEDheto_Rep2:\n")
length(week4_EEDheto_Rep2[week4_EEDheto_Rep2==0])/length(week4_EEDheto_Rep2)
length(week4_EEDheto_Rep2[week4_EEDheto_Rep2<0.05])/length(week4_EEDheto_Rep2)
length(week4_EEDheto_Rep2[week4_EEDheto_Rep2<0.1])/length(week4_EEDheto_Rep2)
length(week4_EEDheto_Rep2[week4_EEDheto_Rep2<0.2])/length(week4_EEDheto_Rep2)
length(week4_EEDheto_Rep2[week4_EEDheto_Rep2<0.3])/length(week4_EEDheto_Rep2)
cat("\n\n\n\n\n")


cat("week4_EEDko_Rep1:\n")
length(week4_EEDko_Rep1[week4_EEDko_Rep1==0])/length(week4_EEDko_Rep1)
length(week4_EEDko_Rep1[week4_EEDko_Rep1<0.05])/length(week4_EEDko_Rep1)
length(week4_EEDko_Rep1[week4_EEDko_Rep1<0.1])/length(week4_EEDko_Rep1)
length(week4_EEDko_Rep1[week4_EEDko_Rep1<0.2])/length(week4_EEDko_Rep1)
length(week4_EEDko_Rep1[week4_EEDko_Rep1<0.3])/length(week4_EEDko_Rep1)
cat("\n\n\n\n\n")

cat("week4_EEDko_Rep2:\n")
length(week4_EEDko_Rep2[week4_EEDko_Rep2==0])/length(week4_EEDko_Rep2)
length(week4_EEDko_Rep2[week4_EEDko_Rep2<0.05])/length(week4_EEDko_Rep2)
length(week4_EEDko_Rep2[week4_EEDko_Rep2<0.1])/length(week4_EEDko_Rep2)
length(week4_EEDko_Rep2[week4_EEDko_Rep2<0.2])/length(week4_EEDko_Rep2)
length(week4_EEDko_Rep2[week4_EEDko_Rep2<0.3])/length(week4_EEDko_Rep2)
cat("\n\n\n\n\n")



cat("banding_Rep1:\n")
length(banding_Rep1[banding_Rep1==0])/length(banding_Rep1)
length(banding_Rep1[banding_Rep1<0.05])/length(banding_Rep1)
length(banding_Rep1[banding_Rep1<0.1])/length(banding_Rep1)
length(banding_Rep1[banding_Rep1<0.2])/length(banding_Rep1)
length(banding_Rep1[banding_Rep1<0.3])/length(banding_Rep1)
cat("\n\n\n\n\n")

cat("banding_Rep2:\n")
length(banding_Rep2[banding_Rep2==0])/length(banding_Rep2)
length(banding_Rep2[banding_Rep2<0.05])/length(banding_Rep2)
length(banding_Rep2[banding_Rep2<0.1])/length(banding_Rep2)
length(banding_Rep2[banding_Rep2<0.2])/length(banding_Rep2)
length(banding_Rep2[banding_Rep2<0.3])/length(banding_Rep2)
cat("\n\n\n\n\n")



cat("sham_Rep1:\n")
length(sham_Rep1[sham_Rep1==0])/length(sham_Rep1)
length(sham_Rep1[sham_Rep1<0.05])/length(sham_Rep1)
length(sham_Rep1[sham_Rep1<0.1])/length(sham_Rep1)
length(sham_Rep1[sham_Rep1<0.2])/length(sham_Rep1)
length(sham_Rep1[sham_Rep1<0.3])/length(sham_Rep1)
cat("\n\n\n\n\n")

cat("sham_Rep2:\n")
length(sham_Rep2[sham_Rep2==0])/length(sham_Rep2)
length(sham_Rep2[sham_Rep2<0.05])/length(sham_Rep2)
length(sham_Rep2[sham_Rep2<0.1])/length(sham_Rep2)
length(sham_Rep2[sham_Rep2<0.2])/length(sham_Rep2)
length(sham_Rep2[sham_Rep2<0.3])/length(sham_Rep2)
cat("\n\n\n\n\n")
...
pdf(file=paste(Part2_g,  "/Part2-2-E-density-whole-Matrix.pdf",      sep = ""))
par( mfrow=c(2, 1) )

plot( density(H3_Rep1[H3_Rep1<2]) , main="H3_Rep1")
plot( density(H3_Rep1[(H3_Rep1<5)&(H3_Rep1>0)]) , main="H3_Rep1")

plot( density(week0_Rep1[week0_Rep1<2]) , main="week0_Rep1")
plot( density(week0_Rep1[(week0_Rep1<5)&(week0_Rep1>0)]) , main="week0_Rep1")

plot( density(week0_Rep2[week0_Rep2<2]) , main="week0_Rep2")
plot( density(week0_Rep2[(week0_Rep2<5)&(week0_Rep2>0)]) , main="week0_Rep2")

plot( density(week1_Rep1[week1_Rep1<2]) , main="week1_Rep1")
plot( density(week1_Rep1[(week1_Rep1<5)&(week1_Rep1>0)]) , main="week1_Rep1")

plot( density(week1_Rep2[week1_Rep2<2]) , main="week1_Rep2")
plot( density(week1_Rep2[(week1_Rep2<5)&(week1_Rep2>0)]) , main="week1_Rep2")

plot( density(week2_Rep1[week2_Rep1<2]) , main="week2_Rep1")
plot( density(week2_Rep1[(week2_Rep1<5)&(week2_Rep1>0)]) , main="week2_Rep1")

plot( density(week2_Rep2[week2_Rep2<2]) , main="week2_Rep2")
plot( density(week2_Rep2[(week2_Rep2<5)&(week2_Rep2>0)]) , main="week2_Rep2")

plot( density(week4_Rep1[week4_Rep1<2]) , main="week4_Rep1")
plot( density(week4_Rep1[(week4_Rep1<5)&(week4_Rep1>0)]) , main="week4_Rep1")

plot( density(week4_Rep2[week4_Rep2<2]) , main="week4_Rep2")
plot( density(week4_Rep2[(week4_Rep2<5)&(week4_Rep2>0)]) , main="week4_Rep2")

plot( density(week4_Rep3[week4_Rep3<2]) , main="week4_Rep3")
plot( density(week4_Rep3[(week4_Rep3<5)&(week4_Rep3>0)]) , main="week4_Rep3")

plot( density(week6_Rep1[week6_Rep1<2]) , main="week6_Rep1")
plot( density(week6_Rep1[(week6_Rep1<5)&(week6_Rep1>0)]) , main="week6_Rep1")

plot( density(week6_Rep2[week6_Rep2<2]) , main="week6_Rep2")
plot( density(week6_Rep2[(week6_Rep2<5)&(week6_Rep2>0)]) , main="week6_Rep2")

plot( density(week8_Rep1[week8_Rep1<2]) , main="week8_Rep1")
plot( density(week8_Rep1[(week8_Rep1<5)&(week8_Rep1>0)]) , main="week8_Rep1")

plot( density(week0_EEDheto_Rep1[week0_EEDheto_Rep1<2]) , main="week0_EEDheto_Rep1")
plot( density(week0_EEDheto_Rep1[(week0_EEDheto_Rep1<5)&(week0_EEDheto_Rep1>0)]) , main="week0_EEDheto_Rep1")

plot( density(week0_EEDheto_Rep2[week0_EEDheto_Rep2<2]) , main="week0_EEDheto_Rep2")
plot( density(week0_EEDheto_Rep2[(week0_EEDheto_Rep2<5)&(week0_EEDheto_Rep2>0)]) , main="week0_EEDheto_Rep2")


plot( density(week0_EEDko_Rep1[week0_EEDko_Rep1<2]) , main="week0_EEDko_Rep1")
plot( density(week0_EEDko_Rep1[(week0_EEDko_Rep1<5)&(week0_EEDko_Rep1>0)]) , main="week0_EEDko_Rep1")


plot( density(week4_EEDheto_Rep1[week4_EEDheto_Rep1<2]) , main="week4_EEDheto_Rep1")
plot( density(week4_EEDheto_Rep1[(week4_EEDheto_Rep1<5)&(week4_EEDheto_Rep1>0)]) , main="week4_EEDheto_Rep1")

plot( density(week4_EEDheto_Rep2[week4_EEDheto_Rep2<2]) , main="week4_EEDheto_Rep2")
plot( density(week4_EEDheto_Rep2[(week4_EEDheto_Rep2<5)&(week4_EEDheto_Rep2>0)]) , main="week4_EEDheto_Rep2")


plot( density(week4_EEDko_Rep1[week4_EEDko_Rep1<2]) , main="week4_EEDko_Rep1")
plot( density(week4_EEDko_Rep1[(week4_EEDko_Rep1<5)&(week4_EEDko_Rep1>0)]) , main="week4_EEDko_Rep1")

plot( density(week4_EEDko_Rep2[week4_EEDko_Rep2<2]) , main="week4_EEDko_Rep2")
plot( density(week4_EEDko_Rep2[(week4_EEDko_Rep2<5)&(week4_EEDko_Rep2>0)]) , main="week4_EEDko_Rep2")


plot( density(banding_Rep1[banding_Rep1<2]) , main="banding_Rep1")
plot( density(banding_Rep1[(banding_Rep1<5)&(banding_Rep1>0)]) , main="banding_Rep1")

plot( density(banding_Rep2[banding_Rep2<2]) , main="banding_Rep2")
plot( density(banding_Rep2[(banding_Rep2<5)&(banding_Rep2>0)]) , main="banding_Rep2")


plot( density(sham_Rep1[sham_Rep1<2]) , main="sham_Rep1")
plot( density(sham_Rep1[(sham_Rep1<5)&(sham_Rep1>0)]) , main="sham_Rep1")

plot( density(sham_Rep2[sham_Rep2<2]) , main="sham_Rep2")
plot( density(sham_Rep2[(sham_Rep2<5)&(sham_Rep2>0)]) , main="sham_Rep2")
...
Average_week4  <- (week4_Rep1+week4_Rep2+week4_Rep3)/3
...
sink( file=paste(Part2_g,  "/Part2-3-A-dimersion-AverageReps.txt",      sep = "") )
dim(Average_H3)
dim(Average_week0)
dim(Average_week1)
dim(Average_week2)
...
sink( file=paste(Part2_g,  "/Part2-3-B-summary-each-column.txt",      sep = "") )
print(  apply(  Average_H3, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  Average_week0, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  Average_week1, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  Average_week2, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  Average_week4, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  Average_week6, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  Average_week8, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  Average_week0_EEDheto, 2, summary )  )  
cat("\n\n\n\n\n")
print(  apply(  Average_week0_EEDko, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  Average_week4_EEDheto, 2, summary )  ) 
cat("\n\n\n\n\n")
print(  apply(  Average_week4_EEDko, 2, summary )  )  
cat("\n\n\n\n\n")
print(  apply(  Average_banding, 2, summary )  )  
cat("\n\n\n\n\n")
print(  apply(  Average_sham, 2, summary )  ) 
sink() 


sink( file=paste(Part2_g,  "/Part2-3-C-summary-whole-Matrix.txt",      sep = "") )
...
sink( file=paste(Part2_g,  "/Part2-3-D-distribution-whole-Matrix.txt",      sep = "") )

cat("Average_H3:\n")
length(Average_H3[Average_H3==0])/length(Average_H3)
length(Average_H3[Average_H3<0.05])/length(Average_H3)
length(Average_H3[Average_H3<0.1])/length(Average_H3)
length(Average_H3[Average_H3<0.2])/length(Average_H3)
length(Average_H3[Average_H3<0.3])/length(Average_H3)
cat("\n\n\n\n\n")

cat("Average_week0:\n")
length(Average_week0[Average_week0==0])/length(Average_week0)
length(Average_week0[Average_week0<0.05])/length(Average_week0)
length(Average_week0[Average_week0<0.1])/length(Average_week0)
length(Average_week0[Average_week0<0.2])/length(Average_week0)
length(Average_week0[Average_week0<0.3])/length(Average_week0)
cat("\n\n\n\n\n")

cat("Average_week1:\n")
length(Average_week1[Average_week1==0])/length(Average_week1)
length(Average_week1[Average_week1<0.05])/length(Average_week1)
length(Average_week1[Average_week1<0.1])/length(Average_week1)
length(Average_week1[Average_week1<0.2])/length(Average_week1)
length(Average_week1[Average_week1<0.3])/length(Average_week1)
cat("\n\n\n\n\n")


cat("Average_week2:\n")
length(Average_week2[Average_week2==0])/length(Average_week2)
length(Average_week2[Average_week2<0.05])/length(Average_week2)
length(Average_week2[Average_week2<0.1])/length(Average_week2)
length(Average_week2[Average_week2<0.2])/length(Average_week2)
length(Average_week2[Average_week2<0.3])/length(Average_week2)
cat("\n\n\n\n\n")


cat("Average_week4:\n")
length(Average_week4[Average_week4==0])/length(Average_week4)
length(Average_week4[Average_week4<0.05])/length(Average_week4)
length(Average_week4[Average_week4<0.1])/length(Average_week4)
length(Average_week4[Average_week4<0.2])/length(Average_week4)
length(Average_week4[Average_week4<0.3])/length(Average_week4)
cat("\n\n\n\n\n")


cat("Average_week6:\n")
length(Average_week6[Average_week6==0])/length(Average_week6)
length(Average_week6[Average_week6<0.05])/length(Average_week6)
length(Average_week6[Average_week6<0.1])/length(Average_week6)
length(Average_week6[Average_week6<0.2])/length(Average_week6)
length(Average_week6[Average_week6<0.3])/length(Average_week6)
cat("\n\n\n\n\n")


cat("Average_week8:\n")
length(Average_week8[Average_week8==0])/length(Average_week8)
length(Average_week8[Average_week8<0.05])/length(Average_week8)
length(Average_week8[Average_week8<0.1])/length(Average_week8)
length(Average_week8[Average_week8<0.2])/length(Average_week8)
length(Average_week8[Average_week8<0.3])/length(Average_week8)
cat("\n\n\n\n\n")


cat("Average_week0_EEDheto:\n")
length(Average_week0_EEDheto[Average_week0_EEDheto==0])/length(Average_week0_EEDheto)
length(Average_week0_EEDheto[Average_week0_EEDheto<0.05])/length(Average_week0_EEDheto)
length(Average_week0_EEDheto[Average_week0_EEDheto<0.1])/length(Average_week0_EEDheto)
length(Average_week0_EEDheto[Average_week0_EEDheto<0.2])/length(Average_week0_EEDheto)
length(Average_week0_EEDheto[Average_week0_EEDheto<0.3])/length(Average_week0_EEDheto)
cat("\n\n\n\n\n")

cat("Average_week0_EEDko:\n")
length(Average_week0_EEDko[Average_week0_EEDko==0])/length(Average_week0_EEDko)
length(Average_week0_EEDko[Average_week0_EEDko<0.05])/length(Average_week0_EEDko)
length(Average_week0_EEDko[Average_week0_EEDko<0.1])/length(Average_week0_EEDko)
length(Average_week0_EEDko[Average_week0_EEDko<0.2])/length(Average_week0_EEDko)
length(Average_week0_EEDko[Average_week0_EEDko<0.3])/length(Average_week0_EEDko)
cat("\n\n\n\n\n")


cat("Average_week4_EEDheto:\n")
length(Average_week4_EEDheto[Average_week4_EEDheto==0])/length(Average_week4_EEDheto)
length(Average_week4_EEDheto[Average_week4_EEDheto<0.05])/length(Average_week4_EEDheto)
length(Average_week4_EEDheto[Average_week4_EEDheto<0.1])/length(Average_week4_EEDheto)
length(Average_week4_EEDheto[Average_week4_EEDheto<0.2])/length(Average_week4_EEDheto)
length(Average_week4_EEDheto[Average_week4_EEDheto<0.3])/length(Average_week4_EEDheto)
cat("\n\n\n\n\n")


cat("Average_week4_EEDko:\n")
length(Average_week4_EEDko[Average_week4_EEDko==0])/length(Average_week4_EEDko)
length(Average_week4_EEDko[Average_week4_EEDko<0.05])/length(Average_week4_EEDko)
length(Average_week4_EEDko[Average_week4_EEDko<0.1])/length(Average_week4_EEDko)
length(Average_week4_EEDko[Average_week4_EEDko<0.2])/length(Average_week4_EEDko)
length(Average_week4_EEDko[Average_week4_EEDko<0.3])/length(Average_week4_EEDko)
cat("\n\n\n\n\n")



cat("Average_banding:\n")
length(Average_banding[Average_banding==0])/length(Average_banding)
length(Average_banding[Average_banding<0.05])/length(Average_banding)
length(Average_banding[Average_banding<0.1])/length(Average_banding)
length(Average_banding[Average_banding<0.2])/length(Average_banding)
length(Average_banding[Average_banding<0.3])/length(Average_banding)
cat("\n\n\n\n\n")



cat("Average_sham:\n")
length(Average_sham[Average_sham==0])/length(Average_sham)
length(Average_sham[Average_sham<0.05])/length(Average_sham)
length(Average_sham[Average_sham<0.1])/length(Average_sham)
length(Average_sham[Average_sham<0.2])/length(Average_sham)
length(Average_sham[Average_sham<0.3])/length(Average_sham)
cat("\n\n\n\n\n")
...
pdf(file=paste(Part2_g,  "/Part2-3-E-density-whole-Matrix.pdf",      sep = ""))
par( mfrow=c(2, 1) )

plot( density(Average_H3[Average_H3<2]) , main="Average_H3")
plot( density(Average_H3[(Average_H3<5)&(Average_H3>0)]) , main="Average_H3")

plot( density(Average_week0[Average_week0<2]) , main="Average_week0")
plot( density(Average_week0[(Average_week0<5)&(Average_week0>0)]) , main="Average_week0")

plot( density(Average_week1[Average_week1<2]) , main="Average_week1")
plot( density(Average_week1[(Average_week1<5)&(Average_week1>0)]) , main="Average_week1")

plot( density(Average_week2[Average_week2<2]) , main="Average_week2")
plot( density(Average_week2[(Average_week2<5)&(Average_week2>0)]) , main="Average_week2")

plot( density(Average_week4[Average_week4<2]) , main="Average_week4")
plot( density(Average_week4[(Average_week4<5)&(Average_week4>0)]) , main="Average_week4")

plot( density(Average_week6[Average_week6<2]) , main="Average_week6")
plot( density(Average_week6[(Average_week6<5)&(Average_week6>0)]) , main="Average_week6")

plot( density(Average_week8[Average_week8<2]) , main="Average_week8")
plot( density(Average_week8[(Average_week8<5)&(Average_week8>0)]) , main="Average_week8")



plot( density(Average_week0_EEDheto[Average_week0_EEDheto<2]) , main="Average_week0_EEDheto")
plot( density(Average_week0_EEDheto[(Average_week0_EEDheto<5)&(Average_week0_EEDheto>0)]) , main="Average_week0_EEDheto")

plot( density(Average_week0_EEDko[Average_week0_EEDko<2]) , main="Average_week0_EEDko")
plot( density(Average_week0_EEDko[(Average_week0_EEDko<5)&(Average_week0_EEDko>0)]) , main="Average_week0_EEDko")

plot( density(Average_week4_EEDheto[Average_week4_EEDheto<2]) , main="Average_week4_EEDheto")
plot( density(Average_week4_EEDheto[(Average_week4_EEDheto<5)&(Average_week4_EEDheto>0)]) , main="Average_week4_EEDheto")

plot( density(Average_week4_EEDko[Average_week4_EEDko<2]) , main="Average_week4_EEDko")
plot( density(Average_week4_EEDko[(Average_week4_EEDko<5)&(Average_week4_EEDko>0)]) , main="Average_week4_EEDko")


plot( density(Average_banding[Average_banding<2]) , main="Average_banding")
plot( density(Average_banding[(Average_banding<5)&(Average_banding>0)]) , main="Average_banding")

plot( density(Average_sham[Average_sham<2]) , main="Average_sham")
plot( density(Average_sham[(Average_sham<5)&(Average_sham>0)]) , main="Average_sham")
...
save.image( file = paste("VID", mySample_g, myCenter_g, ".RData", sep = "_")  )  
#################################################################### End ##########################################################################################################################################
