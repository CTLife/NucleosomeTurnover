...
MyBoxViolinPlot_1(vector2=myNTR_7_WT_1,      sampleType2=c( rep("NTR", numOfRows1)  ), 
                  ...
                  title2=myTitle_g,     xLab2="Samples",    yLab2="NTR",   
                  Ymin2=0,   Ymax2=0.4,    height2=5,   width2=2.5  )
...
MyBoxViolinPlot_1(vector2=HalfLife_7_WT_1,      sampleType2=c( rep("HalfLife", numOfRows1)  ), 
                  ...
                  title2=myTitle_g,     xLab2="Samples",    yLab2="Half life (weeks)",   
                  Ymin2=0,   Ymax2=20,    height2=5,   width2=2.5  )
...
MyBoxViolinPlot_1(vector2=c(myNTR_7_EEDheto_2A,  myNTR_7_EEDko_2B),       
                  ...
                  title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="NTR",   
                  Ymin2=0,   Ymax2=0.3,    height2=5,   width2=3  )
...
MyBoxViolinPlot_1(vector2=c(HalfLife_7_EEDheto_2A,  HalfLife_7_EEDko_2B),       
                  ...
                  title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="Half life (weeks)",   
                  Ymin2=0,   Ymax2=20,    height2=5,   width2=3  )
...
MyBoxViolinPlot_1(vector2=c(myNTR_7_banding_3A,  myNTR_7_sham_3B),       
                  ...
                  title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="NTR",   
                  Ymin2=0,   Ymax2=1.5,    height2=5,   width2=3  )
...
MyBoxViolinPlot_1(vector2=c(HalfLife_7_banding_3A,  HalfLife_7_sham_3B),       
                  ...
                  title2=myTitle_g,     xLab2="Relative distance (kb)",    yLab2="Half life (weeks)",   
                  Ymin2=0,   Ymax2=12,    height2=5,   width2=3  )
...
subdir_9_part4 <- paste(Part4_g,  "/9-NTR-NOL-Correlations", sep = "")
...
length(myNTR_5_WT_1)
MyCor2Vars_2(vector1=row_Average_H3,    vector2=myNTR_5_WT_1, file1=paste(subdir_9_part4,  "/4-9-1A-WT-NTR-H3.txt",      sep="") )
MyCor2Vars_2(vector1=row_Average_week0, vector2=myNTR_5_WT_1, file1=paste(subdir_9_part4,  "/4-9-1B-WT-NTR-week0.txt",   sep="") )

myNTR_withEquation_2( xAxis2=row_Average_H3,  yAxis2=myNTR_5_WT_1,                               
                      path2=subdir_9_part4,  fileName2="4-9-1A-WT-NTR-H3", 
                      titel2=myTitle_g , xlab2="H3", ylab2="NTR", yMin2=0, yMax2=0.4,   xMin2=0, xMax2=1.4)

myNTR_withEquation_2( xAxis2=log(row_Average_H3+1),  yAxis2=myNTR_5_WT_1,                               
                      path2=subdir_9_part4,  fileName2="4-9-1B-WT-NTR-H3-Log", 
                      titel2=myTitle_g , xlab2="log(H3)", ylab2="NTR", yMin2=0, yMax2=0.4,   xMin2=0, xMax2=1.4)


myNTR_withEquation_2( xAxis2=row_Average_week0,  yAxis2=myNTR_5_WT_1,                               
                      path2=subdir_9_part4,  fileName2="4-9-1C-WT-NTR-week0", 
                      titel2=myTitle_g , xlab2="week0", ylab2="NTR", yMin2=0, yMax2=0.4,   xMin2=0, xMax2=1.4)

myNTR_withEquation_2( xAxis2=log(row_Average_week0+1),  yAxis2=myNTR_5_WT_1,                               
                      path2=subdir_9_part4,  fileName2="4-9-1D-WT-NTR-week0-Log", 
                      titel2=myTitle_g , xlab2="log(week0)", ylab2="NTR", yMin2=0, yMax2=0.4,   xMin2=0, xMax2=1.4)
...
length(myNTR_6_WT_1)
MyCor2Vars_2(vector1=reduceColumn2_Average_H3,    vector2=myNTR_6_WT_1, file1=paste(subdir_9_part4,  "/4-9-2A-WT-NTR-H3.txt",      sep="") )
MyCor2Vars_2(vector1=reduceColumn2_Average_week0, vector2=myNTR_6_WT_1, file1=paste(subdir_9_part4,  "/4-9-2B-WT-NTR-week0.txt",   sep="") )

myNTR_withEquation_2( xAxis2=reduceColumn2_Average_H3,  yAxis2=myNTR_6_WT_1,                               
                      path2=subdir_9_part4,  fileName2="4-9-2A-WT-NTR-H3", 
                      titel2=myTitle_g , xlab2="H3", ylab2="NTR", yMin2=0, yMax2=0.4,   xMin2=0, xMax2=1.4)

myNTR_withEquation_2( xAxis2=log(reduceColumn2_Average_H3+1),  yAxis2=myNTR_6_WT_1,                               
                      path2=subdir_9_part4,  fileName2="4-9-2B-WT-NTR-H3-Log", 
                      titel2=myTitle_g , xlab2="log(H3)", ylab2="NTR", yMin2=0, yMax2=0.4,   xMin2=0, xMax2=1.4)


myNTR_withEquation_2( xAxis2=reduceColumn2_Average_week0,  yAxis2=myNTR_6_WT_1,                               
                      path2=subdir_9_part4,  fileName2="4-9-2C-WT-NTR-week0", 
                      titel2=myTitle_g , xlab2="week0", ylab2="NTR", yMin2=0, yMax2=0.4,   xMin2=0, xMax2=1.4)

myNTR_withEquation_2( xAxis2=log(reduceColumn2_Average_week0+1),  yAxis2=myNTR_6_WT_1,                               
                      path2=subdir_9_part4,  fileName2="4-9-2D-WT-NTR-week0-Log", 
                      titel2=myTitle_g , xlab2="log(week0)", ylab2="NTR", yMin2=0, yMax2=0.4,   xMin2=0, xMax2=1.4)
...
MyCor2Vars_2(vector1=reduceColumn3_Average_H3,    vector2=myNTR_7_WT_1, file1=paste(subdir_9_part4,  "/4-9-3A-WT-NTR-H3.txt",      sep="") )
MyCor2Vars_2(vector1=reduceColumn3_Average_week0, vector2=myNTR_7_WT_1, file1=paste(subdir_9_part4,  "/4-9-3B-WT-NTR-week0.txt",   sep="") )

myNTR_withEquation_2( xAxis2=reduceColumn3_Average_H3,  yAxis2=myNTR_7_WT_1,                               
                      path2=subdir_9_part4,  fileName2="4-9-3A-WT-NTR-H3", 
                      titel2=myTitle_g , xlab2="H3", ylab2="NTR", yMin2=0, yMax2=0.4,   xMin2=0, xMax2=1.4)

myNTR_withEquation_2( xAxis2=log(reduceColumn3_Average_H3+1),  yAxis2=myNTR_7_WT_1,                               
                      path2=subdir_9_part4,  fileName2="4-9-3B-WT-NTR-H3-Log", 
                      titel2=myTitle_g , xlab2="log(H3)", ylab2="NTR", yMin2=0, yMax2=0.4,   xMin2=0, xMax2=1.4)


myNTR_withEquation_2( xAxis2=reduceColumn3_Average_week0,  yAxis2=myNTR_7_WT_1,                               
                      path2=subdir_9_part4,  fileName2="4-9-3C-WT-NTR-week0", 
                      titel2=myTitle_g , xlab2="week0", ylab2="NTR", yMin2=0, yMax2=0.4,   xMin2=0, xMax2=1.4)

myNTR_withEquation_2( xAxis2=log(reduceColumn3_Average_week0+1),  yAxis2=myNTR_7_WT_1,                               
                      path2=subdir_9_part4,  fileName2="4-9-3D-WT-NTR-week0-Log", 
                      titel2=myTitle_g , xlab2="log(week0)", ylab2="NTR", yMin2=0, yMax2=0.4,   xMin2=0, xMax2=1.4)
