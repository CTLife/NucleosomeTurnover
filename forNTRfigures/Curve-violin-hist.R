...
###########################################################################################################################################################################
WT_500_rawMatrix1    <- read.table("Adult-H3K9me3/4-1-1B-LogLinearModel_NTR.txt",           header=FALSE,   sep="",   quote = "",   comment.char = "")  
WT_500_rawMatrix2    <- read.table("16-50000_Adult-H3K9me3/4-1-1B-LogLinearModel_NTR.txt",     header=FALSE,   sep="",   quote = "",   comment.char = "")  
WT_500_rawMatrix3    <- read.table("16-50000/4-1-1B-LogLinearModel_NTR.txt",              header=FALSE,   sep="",   quote = "",   comment.char = "")  

Hete_500_rawMatrix4  <- read.table("Adult-H3K9me3/4-1-2A-LogLinearModel_NTR.txt",           header=FALSE,   sep="",   quote = "",   comment.char = "")  
Hete_500_rawMatrix5  <- read.table("16-50000_Adult-H3K9me3/4-1-2A-LogLinearModel_NTR.txt",     header=FALSE,   sep="",   quote = "",   comment.char = "")  
Hete_500_rawMatrix6  <- read.table("16-50000/4-1-2A-LogLinearModel_NTR.txt",              header=FALSE,   sep="",   quote = "",   comment.char = "")  

CKO_500_rawMatrix7   <- read.table("Adult-H3K9me3/4-1-2B-LogLinearModel_NTR.txt",           header=FALSE,   sep="",   quote = "",   comment.char = "")  
CKO_500_rawMatrix8   <- read.table("16-50000_Adult-H3K9me3/4-1-2B-LogLinearModel_NTR.txt",     header=FALSE,   sep="",   quote = "",   comment.char = "")  
CKO_500_rawMatrix9   <- read.table("16-50000/4-1-2B-LogLinearModel_NTR.txt",              header=FALSE,   sep="",   quote = "",   comment.char = "")  
...
###########################################################################################################################################################################
WT_rawMatrix1  <- read.table("Adult-H3K9me3/4-8-1B-WT-LogLinearModel_NTR.txt",   header=FALSE,   sep="",   quote = "",   comment.char = "")  
WT_rawMatrix2  <- read.table("16-50000_Adult-H3K9me3/4-8-1B-WT-LogLinearModel_NTR.txt",     header=FALSE,   sep="",   quote = "",   comment.char = "")  
WT_rawMatrix3  <- read.table("16-50000/4-8-1B-WT-LogLinearModel_NTR.txt",    header=FALSE,   sep="",   quote = "",   comment.char = "")  

Hete_rawMatrix4  <- read.table("Adult-H3K9me3/4-8-2A-2-EEDheto-LogLinearModel_NTR.txt",   header=FALSE,   sep="",   quote = "",   comment.char = "")  
Hete_rawMatrix5  <- read.table("16-50000_Adult-H3K9me3/4-8-2A-2-EEDheto-LogLinearModel_NTR.txt",  header=FALSE,   sep="",   quote = "",   comment.char = "")  
Hete_rawMatrix6  <- read.table("16-50000/4-8-2A-2-EEDheto-LogLinearModel_NTR.txt",  header=FALSE,   sep="",   quote = "",   comment.char = "")  

CKO_rawMatrix7  <- read.table("Adult-H3K9me3/4-8-2B-2-EEDko-LogLinearModel_NTR.txt",  header=FALSE,   sep="",   quote = "",   comment.char = "")  
CKO_rawMatrix8  <- read.table("16-50000_Adult-H3K9me3/4-8-2B-2-EEDko-LogLinearModel_NTR.txt",  header=FALSE,   sep="",   quote = "",   comment.char = "")  
CKO_rawMatrix9  <- read.table("16-50000/4-8-2B-2-EEDko-LogLinearModel_NTR.txt",  header=FALSE,   sep="",   quote = "",   comment.char = "")  
...
spe1_index <- runif(5000, min = 1, max = length(WT_NTR1) )
spe2_index <- runif(8000,  min = 1, max = length(WT_NTR3) )
